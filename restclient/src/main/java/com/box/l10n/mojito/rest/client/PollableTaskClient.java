...
public class PollableTaskClient extends BaseClient {
    ...
    /**
     * @param pollableTaskId {@link PollableTask#id}
     * @return The {@link XliffExportBody} generated by the {@link PollableTask}
     * with the given id
     */
    public XliffExportBody getPollableTaskXliffExport(Long pollableTaskId) {
        return authenticatedRestTemplate.getForObject(getBasePathForResource(pollableTaskId, "xliffExport"), XliffExportBody.class);
    }
}
