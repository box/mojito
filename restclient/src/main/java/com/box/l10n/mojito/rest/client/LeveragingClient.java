...
public class LeveragingClient extends BaseClient {
  ...
  public CopyTmConfig copyTM(CopyTmConfig copyTmConfig) {
    ...
    String exportPath =
        UriComponentsBuilder.fromPath(getBasePathForEntity()).pathSegment("copyTM").toUriString();

    return authenticatedRestTemplate.postForObject(exportPath, copyTmConfig, CopyTmConfig.class);
  }
}
