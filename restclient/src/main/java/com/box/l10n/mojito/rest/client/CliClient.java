...
public class CliClient extends BaseClient {
    ...
    public String getVersion() {
        UriComponentsBuilder uriComponentsBuilder = UriComponentsBuilder.fromPath(getBasePathForEntity()).pathSegment("version");
        logger.error(uriComponentsBuilder.toUriString());
