...
public class StubPhabricatorHttpClient extends PhabricatorHttpClient {
    ...
    public StubPhabricatorHttpClient(File inputDirectory, PhabricatorHttpClient phabricatorHttpClient, Map<String, String> phidMap) {
    ...
    @Override
    public <T extends ResultWithError> T postEntityAndCheckResponse(Method method, HttpEntity<MultiValueMap<String, Object>> httpEntity, Class<T> clazz) throws PhabricatorException {
        try {
            String output;
