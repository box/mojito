...
public class PhabricatorTest extends IOTestBase {
  ...
  public void getRevisionForTargetPhid() {
    StubPhabricatorHttpClient stubPhabricatorHttpClient =
        new StubPhabricatorHttpClient(getInputResourcesTestDir(), phabricatorHttpClient, phidMap);
    ...
    Data<RevisionSearchFields> revisionSearchFieldsData =
        phabricator.getRevisionForTargetPhid("PHID-HMBT-sometest");
