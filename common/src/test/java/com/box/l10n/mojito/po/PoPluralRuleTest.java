...
public class PoPluralRuleTest {
  ...
  public void testArabic() {
    Assert.assertEquals(
        ...
        PoPluralRule.fromBcp47Tag("ar").getRule());
  }
  ...
  public void testLatavian() {
    Assert.assertEquals(
        ...
        PoPluralRule.fromBcp47Tag("lv").getRule());
  }
  ...
  public void testGaelic() {
    Assert.assertEquals(
        "nplurals=3; plural=n==1 ? 0 : n==2 ? 1 : 2;", PoPluralRule.fromBcp47Tag("ga").getRule());
  }
  ...
  public void testRomanian() {
    Assert.assertEquals(
        ...
        PoPluralRule.fromBcp47Tag("ro").getRule());
  }
  ...
  public void testLithuanian() {
    Assert.assertEquals(
        ...
        PoPluralRule.fromBcp47Tag("lt").getRule());
  }
  ...
  public void testRussian() {
    Assert.assertEquals(
        ...
        PoPluralRule.fromBcp47Tag("ru").getRule());
  }
  ...
  public void testCzech() {
    Assert.assertEquals(
        ...
        PoPluralRule.fromBcp47Tag("cs").getRule());
  }
  ...
  public void testPolish() {
    Assert.assertEquals(
        ...
        PoPluralRule.fromBcp47Tag("pl").getRule());
  }
  ...
  public void testSlovenian() {
    Assert.assertEquals(
        ...
        PoPluralRule.fromBcp47Tag("sl").getRule());
  }

  @Test
  public void testPtBR() {
    Assert.assertEquals(
        PoPluralRule.TWO_FORMS_SINGULAR_FOR_ZERO_AND_ONE, PoPluralRule.fromBcp47Tag("pt-BR"));
  }
  ...
  public void testFrFR() {
    Assert.assertEquals(
        PoPluralRule.TWO_FORMS_SINGULAR_FOR_ZERO_AND_ONE, PoPluralRule.fromBcp47Tag("fr-FR"));
  }
  ...
  public void testGa() {
    ...
    Assert.assertEquals(
        Arrays.asList("many", "other"),
        rulesForBcp47Tag.getFormsToCopyOnImport().getFormMap().get("few"));
  }
  ...
  public void testCopyFormSize() {
    for (String bcp47tag : PoPluralRule.mappingForNonDefault.keySet()) {
      ...
      logger.debug(
          "{} --> cldr size: {}, po size: {}, copy size: {}", bcp47tag, cldrSize, poSize, copySize);
