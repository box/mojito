...
public class PhabricatorHttpClientTest {
  ...
  @Before
  public void before() {
    phabricatorHttpClient =
        new PhabricatorHttpClient("https://secure.phabricator.com", "testtoken");
  ...
  public void postEntityAndCheckResponse() {
    ...
    Mockito.doReturn(objectResultWithError)
  ...
  public void getHttpEntityFormUrlEncoded() {
    HttpEntity<MultiValueMap<String, Object>> constraintsForPHID =
        phabricatorHttpClient.getHttpEntityFormUrlEncoded();
  ...
  public void getConstraintsForPHID() {
    HttpEntity<MultiValueMap<String, Object>> constraintsForPHID =
        phabricatorHttpClient.getConstraintsForPHID("PHID-HMBT-sometest");
  ...
  public void getUrl() {
    assertEquals(
        "https://secure.phabricator.com/api/somemethod",
        phabricatorHttpClient.getUrl("somemethod"));
  }
