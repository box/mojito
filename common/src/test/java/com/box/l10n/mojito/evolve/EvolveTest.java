...
public class EvolveTest {
  ...
  public void getCourses() {
    ...
    courses
        .filter(c -> "inTranslation".equals(c.getState()))
        .forEach(c -> logger.info("id: {}, state: {}", c.getId(), c.getState()));
  }
  ...
  public void addVersionAndRtlAttributeToTranslations() throws IOException {
    ...
    String wihtAttribute =
        new Evolve(null).addVersionAndRtlAttributeToTranslations(withoutAttribute, "fr-FR", false);
    Assert.assertEquals(
        "{\"_translations\":{\"5e3e1805bb23502ffd28796c\":{\"_id\":\"5e3e1805bb23502ffd28796c\"},\"_version\":\"fr-FR\",\"_rtl\":false}}",
        wihtAttribute);
  }
}
