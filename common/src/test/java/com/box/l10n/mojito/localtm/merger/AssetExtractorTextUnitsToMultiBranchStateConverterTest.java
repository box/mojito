...
public class AssetExtractorTextUnitsToMultiBranchStateConverterTest {
    ...
    public void convert() {
        ...
        Branch branch1 = Branch.builder().name("branch1").createdAt(new DateTime(2020, 7, 14, 0, 0)).build();

        AssetExtractorTextUnitsToMultiBranchStateConverter assetExtractorTextUnitsToMultiBranchStateConverter = new AssetExtractorTextUnitsToMultiBranchStateConverter(new TextUnitUtils());
        MultiBranchState multiBranchState = assetExtractorTextUnitsToMultiBranchStateConverter.convert(assetExtractorTextUnits, branch1);
    ...
    public void convertToBranchStateTextUnit() {
        ...
        Branch branch = Branch.builder().name("branch1").createdAt(new DateTime(2020, 7, 14, 0, 0)).build();

        BranchStateTextUnit branchStateTextUnit = assetExtractorTextUnitsToMultiBranchStateConverter.convertToBranchStateTextUnit(assetExtractorTextUnit, branch, createdDate);

        assertThat(branchStateTextUnit)
                .isEqualToComparingFieldByField(BranchStateTextUnit.builder()
                        .name("name_one")
                        .source("source")
                        .comments("comment")
                        .pluralForm("one")
                        ...
                        .branchNameToBranchDatas(ImmutableMap.of(
                                branch.getName(),
