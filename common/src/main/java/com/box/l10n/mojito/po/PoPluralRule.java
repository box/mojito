 ...
 *
 * <p>Follows rules defined here:
 * https://www.gnu.org/savannah-checkouts/gnu/gettext/manual/html_node/Plural-forms.html
 *
 * @author jeanaurambault
 */
public enum PoPluralRule {
  ONE_FORM("nplurals=1; plural=0;", PoFormToCLDRForm.ONE_FORM, CldrFormsToCopyOnImport.NONE),
  TWO_FORMS_SINGULAR_FOR_ONE(
      "nplurals=2; plural=n != 1;", PoFormToCLDRForm.TWO_FORMS, CldrFormsToCopyOnImport.NONE),
  ...
  THREE_FORMS_SPECIAL_FOR_ENDING_1_29(
      ...
      PoFormToCLDRForm.THREE_FORMS_ONE_FEW_OTHER, CldrFormsToCopyOnImport.OTHER_TO_MANY),
  ...
  FOUR_FORMS_FRACTIONAL_DIGITS_OTHER(
      ...
      CldrFormsToCopyOnImport.NONE), // diverges from
  // https://www.gnu.org/savannah-checkouts/gnu/gettext/manual/html_node/Plural-forms.html to match
  // CLDR
  SIX_FORMS(
      "nplurals=6; plural=n==0 ? 0 : n==1 ? 1 : n==2 ? 2 : n%100>=3 && n%100<=10 ? 3 : n%100>=11 ? 4 : 5;",
      PoFormToCLDRForm.SIX_FORMS, CldrFormsToCopyOnImport.NONE);

  /** logger */
  static Logger logger = LoggerFactory.getLogger(PoPluralRule.class);

  static final Map<String, PoPluralRule> mappingForNonDefault = new HashMap<>();
  ...
  static {
    ...
    mappingForNonDefault.put(
        "ga", PoPluralRule.THREE_FORMS_SPECIAL_FOR_ONE_TWO); // incompatible with CLDR?
    ...
    mappingForNonDefault.put(
        "ru", PoPluralRule.THREE_FORMS_SPECIAL_FOR_ENDING_1_AND_234_EXCEPT_114);
    mappingForNonDefault.put(
        "uk", PoPluralRule.THREE_FORMS_SPECIAL_FOR_ENDING_1_AND_234_EXCEPT_114);
    mappingForNonDefault.put(
    ...
    mappingForNonDefault.put(
        "sl", PoPluralRule.THREE_FORMS_SPECIAL_ENDING_020310_AND_1199); // incompatible with CLDR?
  ...
  private PoPluralRule(
      String rule, PoFormToCLDRForm poFormToCLDRForm, CldrFormsToCopyOnImport formsToCopyOnImport) {
    this.rule = rule;
  ...
  public static PoPluralRule fromBcp47Tag(String bcp47tag) {
  ...
  public enum PoFormToCLDRForm {
    ...
    TWO_FORMS(
        ImmutableBiMap.of(
            "0", "one",
            "1", "other")),
    THREE_FORMS_ONE_FEW_MANY(
        ImmutableBiMap.of(
            "0", "one",
            "1", "few",
            "2", "many")),
    THREE_FORMS_ONE_FEW_OTHER(
        ImmutableBiMap.of(
            "0", "one",
            "1", "few",
            "2", "other")),
    THREE_FORMS_ONE_TWO_FEW(
        ImmutableBiMap.of(
            "0", "one",
            "1", "two",
            "2", "few")),
    FOUR_FORMS_ONE_TWO_MANY_OTHER(
        ImmutableBiMap.of(
            "0", "one",
            "1", "two",
            "2", "many",
