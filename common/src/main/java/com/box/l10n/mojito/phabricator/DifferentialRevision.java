...
public class DifferentialRevision {
  ...
  Data<RevisionSearchFields> getRevision(String revisionPHID) {
    try {
      RevisionSearchResult revisionSearchResponse =
  ...
  public void addComment(String objectIdentifier, String value) throws PhabricatorException {
    ...
    phabricatorHttpClient.postEntityAndCheckResponse(
        Method.DIFFERENTIAL_REVISION_EDIT, httpEntity, ResultWithError.class);
  }

  public void removeReviewer(String objectIdentifier, String value, boolean blocking)
  ...
  public void addReviewer(String objectIdentifier, String value, boolean blocking)
      throws PhabricatorException {
    logger.debug("Add reviewer: {} from: {}", value, objectIdentifier);
  ...
  @SuppressWarnings("Duplicates")
  void changeReviewer(String objectIdentifier, String value, boolean blocking, String txType)
      throws PhabricatorException {
