...
public class AssetExtractorTextUnitsToMultiBranchStateConverter {
    ...
    public MultiBranchState convert(List<AssetExtractorTextUnit> assetExtractorTextUnits, Branch branch) {
        ...
        ImmutableList<BranchStateTextUnit> branchStateTextUnitImmutableMap = assetExtractorTextUnits.stream()
                .map(assetExtractorTextUnit -> convertToBranchStateTextUnit(assetExtractorTextUnit, branch, now))
    ...
    BranchStateTextUnit convertToBranchStateTextUnit(AssetExtractorTextUnit assetExtractorTextUnit, Branch branch, DateTime createdDate) {

        BranchData branchData = BranchData.of()
                .withUsages(assetExtractorTextUnit.getUsages() == null ?
                        ImmutableSet.of() :
                        ImmutableSet.copyOf(assetExtractorTextUnit.getUsages()));

        BranchStateTextUnit branchStateTextUnit = BranchStateTextUnit.builder()
