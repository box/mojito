 ...
 *
 * <p>It does not escape supported HTML elements for Android strings unless there are variables
 * within the HTML elements. For example, <b>songs</b> vs. &lt;b>%d songs&lt;/b>
 *
 * <p>Also it overrides the default quotemode setting so the quotes do not get escaped.
 *
 * <p>For detailed information, see to Android specification in
...
public class AndroidXMLEncoder extends net.sf.okapi.common.encoder.XMLEncoder {
  ...
  public String escapeAndroidOld(String text) {
    ...
    boolean enclosedInDoubleQuotes =
    ...
    while (matcher.find()) {
      matcher.appendReplacement(
          ...
          Matcher.quoteReplacement(
              (needsAndroidEscapeHTML ? matcher.group(1) : "<")
                  + matcher.group(2)
