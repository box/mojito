...
public class SlaCheckerServiceTest {
  ...
  @Spy @InjectMocks SlaCheckerService slaCheckerService;

  @Mock SlaIncidentRepository slaIncidentRepository;

  @Mock SlaCheckerEmailService slaCheckerEmailService;
  ...
  public void testCheckWithOpenIncidentDoNothing() {
    ...
    verify(slaCheckerEmailService, never())
        .sendOpenIncidentEmail(openIncident.getId(), repositories);
  }
  ...
  public void testCheckWithNoOpenIncidentNothing() {
    ...
    verify(slaCheckerEmailService, never())
        .sendOpenIncidentEmail(anyLong(), ArgumentMatchers.anyList());
  }
