...
public class TMTextUnitVariantCommentAnnotationsTest {
  ...
  public void testAddandGetAnnotations() {
    ...
    List<TMTextUnitVariantCommentAnnotation> annotations =
        tmTextUnitVariantCommentAnnotations.getAnnotations();
    Assert.assertEquals(0, annotations.size());

    TMTextUnitVariantCommentAnnotation tmTextUnitVariantCommentAnnotation1 =
        new TMTextUnitVariantCommentAnnotation();
    TMTextUnitVariantCommentAnnotation tmTextUnitVariantCommentAnnotation2 =
        new TMTextUnitVariantCommentAnnotation();
    TMTextUnitVariantCommentAnnotation tmTextUnitVariantCommentAnnotation3 =
        new TMTextUnitVariantCommentAnnotation();
