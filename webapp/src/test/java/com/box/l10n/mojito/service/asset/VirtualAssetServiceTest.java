...
public class VirtualAssetServiceTest extends ServiceTestBase {
  ...
  public void testCreateVirtualAsset() throws Exception {
    Repository repository =
        repositoryService.createRepository(testIdWatcher.getEntityName("testCreateVirtualAsset"));
  ...
  public void testUpdateVirtualAsset() throws Exception {
    Repository repository =
        repositoryService.createRepository(testIdWatcher.getEntityName("testUpdateVirtualAsset"));
    VirtualAsset virtualAsset = new VirtualAsset();
    virtualAsset.setRepositoryId(repository.getId());
    virtualAsset.setPath("default");
    virtualAssetService.createOrUpdateVirtualAsset(virtualAsset);
  ...
  public void testCantUpdateAssetAsVirtual() throws Exception {
    Repository repository =
        repositoryService.createRepository(
            testIdWatcher.getEntityName("testCantUpdateAssetAsVirtual"));
  ...
  public void testAddTextUnit() throws Exception {
    Repository repository =
        repositoryService.createRepository(testIdWatcher.getEntityName("testAddTextUnit"));
    VirtualAsset virtualAsset = new VirtualAsset();
    virtualAsset.setRepositoryId(repository.getId());
    virtualAsset.setPath("default");
    ...
    virtualAssetService.addTextUnit(
        virtualAsset.getId(), "name", "content", "comment", null, null, true);

    List<VirtualAssetTextUnit> textUnits =
        virtualAssetService.getTextUnits(virtualAsset.getId(), null);
  ...
  public void testGetTextunitWithDoNoTranslateFilter() throws Exception {
    Repository repository =
        repositoryService.createRepository(
            testIdWatcher.getEntityName("testGetTextunitWithDoNoTranslateFilter"));
    VirtualAsset virtualAsset = new VirtualAsset();
    virtualAsset.setRepositoryId(repository.getId());
    virtualAsset.setPath("default");
    virtualAsset = virtualAssetService.createOrUpdateVirtualAsset(virtualAsset);
    ...
    virtualAssetService.addTextUnit(
        virtualAsset.getId(), "name", "content", "comment", null, null, false);
    ...
    List<VirtualAssetTextUnit> doNotTranslateTextUnits =
        virtualAssetService.getTextUnits(virtualAsset.getId(), true);
    ...
    List<VirtualAssetTextUnit> translateTextUnits =
        virtualAssetService.getTextUnits(virtualAsset.getId(), false);
  ...
  public void testResetOfDoNoTranslateFilter() throws Exception {
    Repository repository =
        repositoryService.createRepository(
            testIdWatcher.getEntityName("testResetOfDoNoTranslateFilter"));
    VirtualAsset virtualAsset = new VirtualAsset();
    virtualAsset.setRepositoryId(repository.getId());
    virtualAsset.setPath("default");
    virtualAsset = virtualAssetService.createOrUpdateVirtualAsset(virtualAsset);
    ...
    virtualAssetService.addTextUnit(virtualAssetId, "name", "content", "comment", null, null, true);
    ...
    virtualAssetService.addTextUnit(
        virtualAssetId, "name", "content", "comment", null, null, false);
  ...
  public void testCantAddTextUnitToNoVirtual() throws Exception {
    Repository repository =
        repositoryService.createRepository(
            testIdWatcher.getEntityName("testCantAddTextUnitToNoVirtual"));
  ...
  public void testAddTextUnitVariant() throws Exception {
    Repository repository =
        repositoryService.createRepository(testIdWatcher.getEntityName("testAddTextUnitVariant"));
    ...
    TMTextUnitVariant addTextUnitVariant =
        virtualAssetService.addTextUnitVariant(
            virtualAsset.getId(), frFRLocaleId, "name_plural_other", "content-fr", "comment-fr");
    Assert.assertNotNull(addTextUnitVariant.getId());

    List<VirtualAssetTextUnit> loalizedTextUnits =
        virtualAssetService.getLocalizedTextUnits(
            virtualAsset.getId(), frFRLocaleId, InheritanceMode.REMOVE_UNTRANSLATED);
  ...
  public void testAddGetReplaceTextUnits() throws Exception {
    Repository repository =
        repositoryService.createRepository(
            testIdWatcher.getEntityName("testAddGetReplaceTextUnits"));
    ...
    List<VirtualAssetTextUnit> replacedTextUnits =
        virtualAssetService.getTextUnits(virtualAsset.getId(), null);
  ...
  public void testImportLocalizedTextUnits() throws Exception {
    Repository repository =
        repositoryService.createRepository(
            testIdWatcher.getEntityName("testImportLocalizedTextUnits"));
    RepositoryLocale repositoryLocaleFrFR =
        repositoryService.addRepositoryLocale(repository, "fr-FR");
    long frFRLocaleId = repositoryLocaleFrFR.getLocale().getId();
    ...
    PollableFuture<Void> importLocalizedTextUnits =
        virtualAssetService.importLocalizedTextUnits(
            virtualAsset.getId(), frFRLocaleId, localizedVirtualAssetTextUnits);
  ...
  public void testImportLocalizedTextUnitsOneMissing() throws Exception {
    Repository repository =
        repositoryService.createRepository(
            testIdWatcher.getEntityName("testImportLocalizedTextUnitsOneMissing"));
    RepositoryLocale repositoryLocaleFrFR =
        repositoryService.addRepositoryLocale(repository, "fr-FR");
    long frFRLocaleId = repositoryLocaleFrFR.getLocale().getId();
  ...
  public void testDeleteTextUnit() throws Exception {
    ...
    Repository repository =
        repositoryService.createRepository(testIdWatcher.getEntityName("testDeleteTextUnit"));
    VirtualAsset virtualAsset = new VirtualAsset();
    virtualAsset.setRepositoryId(repository.getId());
    virtualAsset.setPath("default");
    virtualAsset = virtualAssetService.createOrUpdateVirtualAsset(virtualAsset);
  ...
  public void testLeveragingByName() throws Exception {
    ...
    Repository repository =
        repositoryService.createRepository(testIdWatcher.getEntityName("testLeveragingByName"));
    RepositoryLocale repositoryLocaleFrFR =
        repositoryService.addRepositoryLocale(repository, "fr-FR");
    long frFRLocaleId = repositoryLocaleFrFR.getLocale().getId();
    ...
    TMTextUnitVariant addTextUnitVariant =
        virtualAssetService.addTextUnitVariant(
            virtualAsset.getId(), frFRLocaleId, "name", "content-fr", null);

    virtualAssetService.addTextUnit(
        virtualAsset.getId(), "name", "new content", "comment", null, null, false);
    ...
    List<VirtualAssetTextUnit> localizedTextUnits =
        virtualAssetService.getLocalizedTextUnits(
            virtualAsset.getId(), frFRLocaleId, InheritanceMode.REMOVE_UNTRANSLATED);
    ...
    virtualAssetService
        .replaceTextUnits(virtualAsset.getId(), Arrays.asList(virtualAssetTextUnit))
        .get();
  ...
  public void testLeveragingByContent() throws Exception {
    ...
    Repository repository =
        repositoryService.createRepository(testIdWatcher.getEntityName("testLeveragingByContent"));
    RepositoryLocale repositoryLocaleFrFR =
        repositoryService.addRepositoryLocale(repository, "fr-FR");
    long frFRLocaleId = repositoryLocaleFrFR.getLocale().getId();
    ...
    virtualAssetService.addTextUnit(
        virtualAsset.getId(), "new name", "content", "comment", null, null, false);
  ...
  public void testRemovePreviousWhenExactMatches() throws Exception {
    ...
    Repository repository =
        repositoryService.createRepository(
            testIdWatcher.getEntityName("testRemovePreviousWhenExactMatches"));
    VirtualAsset virtualAsset = new VirtualAsset();
    virtualAsset.setRepositoryId(repository.getId());
    virtualAsset.setPath("default");
    virtualAsset = virtualAssetService.createOrUpdateVirtualAsset(virtualAsset);
    ...
    virtualAssetService.addTextUnit(
        virtualAsset.getId(), "name", "content", null, null, null, true);
  ...
  public void testChangeDoNotTranslateWhenExactMatches() throws Exception {
    ...
    Repository repository =
        repositoryService.createRepository(
            testIdWatcher.getEntityName("testChangeDoNotTranslateWhenExactMatches"));
    VirtualAsset virtualAsset = new VirtualAsset();
    virtualAsset.setRepositoryId(repository.getId());
    virtualAsset.setPath("default");
    virtualAsset = virtualAssetService.createOrUpdateVirtualAsset(virtualAsset);
  ...
  public void testFetchAllPluralForm() throws Exception {
    Repository repository =
        repositoryService.createRepository(testIdWatcher.getEntityName("testFetchAllPluralForm"));
