...
public class GitBlameServiceTest extends ServiceTestBase {
  ...
  public void getGitBlameWithUsages() throws Exception {
    ...
    gitBlameService.saveGitBlameWithUsages(gitBlameWithUsages).get();
    List<GitBlameWithUsage> gitBlameWithUsagesAfterSave =
        gitBlameService.getGitBlameWithUsages(textUnitSearcherParameters);
    ...
    for (GitBlameWithUsage gitBlameWithUsage : gitBlameWithUsages) {
      ...
      assertEquals(
          gitBlameWithUsage.getTextUnitName() + "-author-email", gitBlame.getAuthorEmail());
    ...
    List<GitBlameWithUsage> gitBlameWithUsagesAfterUpdate =
        gitBlameService.getGitBlameWithUsages(textUnitSearcherParameters);
    ...
    for (GitBlameWithUsage gitBlameWithUsage : gitBlameWithUsages) {
      GitBlame gitBlame = gitBlameWithUsage.getGitBlame();
      assertEquals(
          gitBlameWithUsage.getTextUnitName() + "-author-name-up", gitBlame.getAuthorName());
      assertEquals(
          gitBlameWithUsage.getTextUnitName() + "-author-email-up", gitBlame.getAuthorEmail());
      assertEquals(
          gitBlameWithUsage.getTextUnitName() + "-commit-name-up", gitBlame.getCommitName());
      assertEquals(
          gitBlameWithUsage.getTextUnitName() + "-commit-time-up", gitBlame.getCommitTime());
    }
  }
  ...
  public void testgetGitBlameWithUsagesByTmTextUnitIdRemovesDuplicates() {
    ...
    Set<Long> gitBlameWithUsagesByTmTextUnitId =
        gitBlameService.getGitBlameWithUsagesByTmTextUnitId(gitBlameWithUsages).keySet();
