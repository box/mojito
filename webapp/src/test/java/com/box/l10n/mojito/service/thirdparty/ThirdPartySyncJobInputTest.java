...
public class ThirdPartySyncJobInputTest {
  ...
  public void testBackwardsCompatibility() {
    ...
    List<ThirdPartySyncAction> actions =
        Arrays.asList(ThirdPartySyncAction.MAP_TEXTUNIT, ThirdPartySyncAction.PULL);
    List<String> options =
        Arrays.asList(
    ...
    ThirdPartySyncJobInput input =
        objectMapper.readValueUnchecked(oldRes, ThirdPartySyncJobInput.class);
  ...
  /**
   * Copy of the signature of the {@link ThirdPartySyncJobInput} class before we introduced new
   * parameters to it
   */
