...
public class AssetMappingServiceTest extends ServiceTestBase {
    ...
    public void testMap() throws RepositoryLocaleCreationException, RepositoryNameAlreadyUsedException {
        ...
        assetMappingService.mapAssetTextUnitAndCreateTMTextUnit(assetExtraction.getId(), tm.getId(), asset.getId(), PollableTask.INJECT_CURRENT_TASK, null);
        ...
        assetMappingService.mapAssetTextUnitAndCreateTMTextUnit(assetExtraction2.getId(), tm.getId(), asset.getId(), PollableTask.INJECT_CURRENT_TASK, null);
        ...
        assetMappingService.mapAssetTextUnitAndCreateTMTextUnit(assetExtraction3.getId(), tm.getId(), asset.getId(), PollableTask.INJECT_CURRENT_TASK, null);
    ...
    public void testSourceLeveraging() throws RepositoryLocaleCreationException, RepositoryNameAlreadyUsedException {
        ...
        assetMappingService.mapAssetTextUnitAndCreateTMTextUnit(assetExtraction4.getId(), tm.getId(), asset.getId(), PollableTask.INJECT_CURRENT_TASK, null);
        ...
        assetMappingService.mapAssetTextUnitAndCreateTMTextUnit(assetExtraction5.getId(), tm.getId(), asset.getId(), PollableTask.INJECT_CURRENT_TASK, null);
        ...
        assetMappingService.mapAssetTextUnitAndCreateTMTextUnit(assetExtraction6.getId(), tm.getId(), asset.getId(), PollableTask.INJECT_CURRENT_TASK, null);
