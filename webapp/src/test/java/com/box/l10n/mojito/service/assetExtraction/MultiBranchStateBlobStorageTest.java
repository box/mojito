...
public class MultiBranchStateBlobStorageTest extends ServiceTestBase {
    ...
    public void test() {
        ...
        Optional<MultiBranchState> multiBranchStateForAssetExtractionId = multiBranchStateBlobStorage.getMultiBranchStateForAssetExtractionId(assetExtractionId, version);
        ...
        MultiBranchState multiBranchState = MultiBranchState.builder()
                .branches(ImmutableSet.of(branchTest))
                .branchStateTextUnits(ImmutableList.of(BranchStateTextUnit.builder()
        ...
        multiBranchStateForAssetExtractionId = multiBranchStateBlobStorage.getMultiBranchStateForAssetExtractionId(assetExtractionId, version);
        assertThat(multiBranchStateForAssetExtractionId.get()).isEqualToComparingFieldByField(multiBranchState);
    }
