...
@SpringBootTest(classes = {
        ...
        com.box.l10n.mojito.service.branch.notification.phabricator.BranchNotificationCustomMessageBuilderPhabricatorTest.class,
        BranchUrlBuilder.class,
        ServerConfig.class},
        properties = {"l10n.branchNotification.phabricator.notification.message.new=Custom message text for new messages stating the time that screenshots need to be uploaded ",
...
public class BranchNotificationCustomMessageBuilderPhabricatorTest {
    ...
    public void getCustomNewMessage() {
        ...
        assertEquals("Custom message text for new messages stating the time that screenshots need to be uploaded " +
