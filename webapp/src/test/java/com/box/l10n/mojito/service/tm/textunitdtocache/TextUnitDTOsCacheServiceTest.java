...
public class TextUnitDTOsCacheServiceTest extends ServiceTestBase {
    ...
    public void testNoValueInCacheNoUpdate() {
        ...
        textUnitDTOsCacheBlobStorage.structuredBlobStorage.delete(StructuredBlobStorage.Prefix.TEXT_UNIT_DTOS_CACHE, textUnitDTOsCacheBlobStorage.getName(tmTestData.asset.getId(), tmTestData.en.getId()));
        ImmutableMap<String, TextUnitDTO> withoutUpdate = textUnitDTOsCacheService.getTextUnitDTOsForAssetAndLocaleByMD5(tmTestData.asset.getId(), tmTestData.en.getId(), null, true, UpdateType.NEVER);
    ...
    public void testNoValueInCacheUpdateIfMissing() {
        TMTestData tmTestData = new TMTestData(testIdWatcher);
        textUnitDTOsCacheBlobStorage.structuredBlobStorage.delete(StructuredBlobStorage.Prefix.TEXT_UNIT_DTOS_CACHE, textUnitDTOsCacheBlobStorage.getName(tmTestData.asset.getId(), tmTestData.en.getId()));
        ImmutableMap<String, TextUnitDTO> updateIfMissing = textUnitDTOsCacheService.getTextUnitDTOsForAssetAndLocaleByMD5(tmTestData.asset.getId(), tmTestData.en.getId(), null, true, UpdateType.IF_MISSING);
    ...
    public void testRootLocaleWithPlurals() {
        ...
        ImmutableMap<String, TextUnitDTO> textUnitDTOsForAssetAndLocaleByMD5 = textUnitDTOsCacheService.getTextUnitDTOsForAssetAndLocaleByMD5(tmTestData.asset.getId(), tmTestData.en.getId(), null, true, UpdateType.ALWAYS);
    ...
    public void testStandardLocaleWithPlural() {
        ...
        ImmutableMap<String, TextUnitDTO> textUnitDTOsForAssetAndLocaleByMD5 = textUnitDTOsCacheService.getTextUnitDTOsForAssetAndLocaleByMD5(tmTestData.asset.getId(), tmTestData.frFR.getId(), null, false, UpdateType.ALWAYS);
        assertThat(textUnitDTOsForAssetAndLocaleByMD5.values().stream())
        ...
        textUnitDTOsForAssetAndLocaleByMD5 = textUnitDTOsCacheService.getTextUnitDTOsForAssetAndLocaleByMD5(tmTestData.asset.getId(), tmTestData.frFR.getId(), FOR_TRANSLATION, false, UpdateType.ALWAYS);
        assertThat(textUnitDTOsForAssetAndLocaleByMD5.values().stream())
        ...
        textUnitDTOsForAssetAndLocaleByMD5 = textUnitDTOsCacheService.getTextUnitDTOsForAssetAndLocaleByMD5(tmTestData.asset.getId(), tmTestData.frFR.getId(), APPROVED_AND_NOT_REJECTED, false, UpdateType.ALWAYS);
        assertThat(textUnitDTOsForAssetAndLocaleByMD5.values().stream())
        ...
        Long idToRemove = tmTextUnitCurrentVariantRepository.findByLocale_IdAndTmTextUnit_Id(tmTestData.frFR.getId(), tmTestData.addTMTextUnit3.getId()).getId();

        tmService.addCurrentTMTextUnitVariant(tmTestData.addTMTextUnit1.getId(), tmTestData.frFR.getId(), "Veuillez indiquer un état, une région ou une province valide. - update");
        tmTextUnitCurrentVariantService.removeCurrentVariant(idToRemove);
        tmService.addCurrentTMTextUnitVariant(plural1.get("one").getId(), tmTestData.frFR.getId(), "plural1 - one - fr");
        textUnitDTOsForAssetAndLocaleByMD5 = textUnitDTOsCacheService.getTextUnitDTOsForAssetAndLocaleByMD5(tmTestData.asset.getId(), tmTestData.frFR.getId(), null, false, UpdateType.ALWAYS);
        assertThat(textUnitDTOsForAssetAndLocaleByMD5.values().stream())
