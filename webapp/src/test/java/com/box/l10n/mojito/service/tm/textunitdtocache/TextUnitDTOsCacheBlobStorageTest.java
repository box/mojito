...
public class TextUnitDTOsCacheBlobStorageTest extends ServiceTestBase {
    ...
    public void readInvalidData() {
        ...
        long localeId = 234L;
        textUnitDTOsCacheBlobStorage.structuredBlobStorage.put(TEXT_UNIT_DTOS_CACHE, textUnitDTOsCacheBlobStorage.getName(assetId, localeId), "bad content", Retention.PERMANENT);
        List<TextUnitDTO> textUnitDTOS = textUnitDTOsCacheBlobStorage.getTextUnitDTOs(assetId, localeId).get();
    ...
    public void readNoData() {
        long assetId = 123243L;
        long localeId = 234L;
        textUnitDTOsCacheBlobStorage.structuredBlobStorage.delete(TEXT_UNIT_DTOS_CACHE, textUnitDTOsCacheBlobStorage.getName(assetId, localeId));
        Optional<ImmutableList<TextUnitDTO>> textUnitDTOS = textUnitDTOsCacheBlobStorage.getTextUnitDTOs(assetId, localeId);
    ...
    public void writeAndRead() {
        ...
        List<TextUnitDTO> readTextUnitDTOS = textUnitDTOsCacheBlobStorage.getTextUnitDTOs(12345L, 12345L).get();
