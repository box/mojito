  ...
  public void testExportAssetAsXLIFF() throws RepositoryNameAlreadyUsedException {
    ...
    assertEquals(
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
            ...
            + "<source xml:lang=\"en\">Home</source>\n"
            + "<target xml:lang=\"fr-FR\">Page d'accueil</target>\n"
            + "<note>{\"sourceComment\":\"This is the text displayed in the link that takes the user to the home page.\",\"targetComment\":\"this string has some comments\",\"includedInLocalizedFile\":false,\"status\":\"REVIEW_NEEDED\",\"variantComments\":[{\"severity\":\"INFO\",\"type\":\"LEVERAGING\",\"content\":\"Leveraging\",\"createdByUser\":{\"username\":\"admin\",\"enabled\":true,\"surname\":null,\"givenName\":null,\"commonName\":null,\"canTranslateAllLocales\":true,\"partiallyCreated\":false,\"userLocales\":null,\"authorities\":[{\"authority\":\"ROLE_ADMIN\"}]}},{\"severity\":\"ERROR\",\"type\":\"INTEGRITY_CHECK\",\"content\":\"Failed Integrity Check\",\"createdByUser\":{\"username\":\"admin\",\"enabled\":true,\"surname\":null,\"givenName\":null,\"commonName\":null,\"canTranslateAllLocales\":true,\"partiallyCreated\":false,\"userLocales\":null,\"authorities\":[{\"authority\":\"ROLE_ADMIN\"}]}}],\"pluralForm\":null,\"pluralFormOther\":null}</note>\n"
            + "</trans-unit>\n"
            + "</body>\n"
            + "</file>\n"
            + "</xliff>\n",
