...
public class HtmlTagIntegrityCheckerTest {
  ...
  public void testHtmlTagCheckWorksForNestedTags() {
    String source =
        "<div id=\"asdf\">There are <span class=\"foo\">%1</span> files and %2 folders</div>";
    String target =
        "<div id=\"asdf\">Il y a <span class=\"foo\">%1</span> fichiers et %2 dossiers</div>";
  ...
  public void testHtmlTagCheckWorksForNoValueAttributes() {
    String source =
        "<option selected>There are <span class=\"foo\">%1</span> files and %2 folders</option>";
    String target =
        "<option selected>Il y a <span class=\"foo\">%1</span> fichiers et %2 dossiers</option>";
  ...
  public void testHtmlTagCheckIncorrectTagNameCase() {
    String source =
        "<span class=\"asdf\">There are <span class=\"foo\">%1</span> files and %2 folders</option>";
    String target =
        "<Span class=\"asdf\">Il y a <span class=\"foo\">%1</span> fichiers et %2 dossiers</option>";
