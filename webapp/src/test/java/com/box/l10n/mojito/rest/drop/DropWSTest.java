...
public class DropWSTest extends WSTestBase {
    ...
    public void testExportDrop() throws InterruptedException, ResourceNotCreatedException {
        ...
        Repository repository = repositoryClient.createRepository(testIdWatcher.getEntityName("repository"), null, null, repositoryLocales, null, null);
    ...
    public void testImportDrop() throws Exception {
        ...
        ImportDropConfig importDropResult = dropClient.importDrop(repository, exportDropConfig.getDropId(), null);
    ...
    /**
     * Just calls the import logic with an XLIFF that contains a single
     * translation that is not valid. The expectation is that the text unit will
     * be skipped and flagged for review. No translation will be imported in the
     * project.
     *
     * @throws Exception
     */
    ...
    public void testImportDropXliff() throws Exception {
        ...
        assertEquals("The text unit doesn't exist in the repository hence must be marked as skipped", expectedXliff, importedXliff);
    }
