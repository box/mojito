...
public class AndroidStringDocumentReaderTest {
  ...
  public void testBuildFromFileRegular() throws Exception {
    ...
    path =
        Resources.getResource("com/box/l10n/mojito/android/strings/copytune_pinboard.xml")
            .getPath();
  ...
  public void testBuildFromFileKorean() throws Exception {
    ...
    path =
        Resources.getResource("com/box/l10n/mojito/android/strings/copytune_pinboard_ko-KR.xml")
            .getPath();
    document = AndroidStringDocumentReader.fromFile(path);
    ...
    assertThat(plural.getItems().get(OTHER).getContent())
        .isEqualTo("[Plural form OTHER]: {num_pins} Pins");
  }
