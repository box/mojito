...
public class UserWSTest extends WSTestBase {
    ...
    @Test
    public void testCreateAndDeleteUser() throws ResourceNotCreatedException, ResourceNotFoundException {
    ...
    private User createTestUser(String username) throws ResourceNotCreatedException {
        ...
        User user = userClient.createUser(username, password, Role.USER, surname, givenName, commonName);
