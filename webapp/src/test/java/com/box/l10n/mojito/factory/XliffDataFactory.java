...
public class XliffDataFactory {
     ...
     * @return
     */
    public TextUnit createTextUnit(Long id, String name, String source, String note, String target, String targetBcp47Tag, XliffState state) {
    ...
    private String generateXliff(List<TextUnit> textUnits, String targetBcp47Tag) {
        ...
        for (TextUnit textUnit : textUnits) {
            xliff += "   <trans-unit id=\"" + textUnit.getId() + "\" resname=\"" + textUnit.getName() + "\">\n";
