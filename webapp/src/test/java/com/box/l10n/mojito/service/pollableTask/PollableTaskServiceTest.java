...
public class PollableTaskServiceTest extends ServiceTestBase {
    ...
    public void testCreateParentTask() {
        PollableTask createPollableTask = pollableTaskService.createPollableTask(null, testIdWatcher.getEntityName("testCreateParentTask"), "a message", 15);
    ...
    public void testCreateSubTask() {
        ...
        PollableTask parent = pollableTaskService.createPollableTask(null, testIdWatcher.getEntityName("testCreateSubTask"), "a message", 2);
        PollableTask createSubTask1 = pollableTaskService.createPollableTask(parent.getId(), testIdWatcher.getEntityName("testCreateSubTask-Sub1"), "sub1 message", 0);
        PollableTask createSubTask2 = pollableTaskService.createPollableTask(parent.getId(), testIdWatcher.getEntityName("testCreateSubTask-Sub2"), "sub2 message", 0);
    ...
    public void testFinishTask() {
        PollableTask createPollableTask = pollableTaskService.createPollableTask(null, testIdWatcher.getEntityName("testFinishTask"), null, 2);
    ...
    public void testCompoundStatusWithSubTasks() {
        ...
        PollableTask createPollableTask = pollableTaskService.createPollableTask(null, testIdWatcher.getEntityName("testCompoundStatusWithSubTasks"), null, 2);
        PollableTask sub1 = pollableTaskService.createPollableTask(createPollableTask.getId(), testIdWatcher.getEntityName("testCompoundStatusParentWithSubTaskFinished-Sub1"), null, 0);
        PollableTask sub2 = pollableTaskService.createPollableTask(createPollableTask.getId(), testIdWatcher.getEntityName("testCompoundStatusParentWithSubTaskFinished-Sub2"), null, 0);
    ...
    public void test3Level() {
        PollableTask createParentTask = pollableTaskService.createPollableTask(null, testIdWatcher.getEntityName("test3Level"), null, 1);
        PollableTask sub = pollableTaskService.createPollableTask(createParentTask.getId(), testIdWatcher.getEntityName("test3Level-sub"), null, 1);
        PollableTask subsub = pollableTaskService.createPollableTask(sub.getId(), testIdWatcher.getEntityName("test3Level-sub-sub"), null, 0);
    ...
    public void testUpdateExpectedSubTaskNumber() {
        PollableTask createPollableTask = pollableTaskService.createPollableTask(null, testIdWatcher.getEntityName("testUpdateExpectedSubTaskNumber"), null, 1);
