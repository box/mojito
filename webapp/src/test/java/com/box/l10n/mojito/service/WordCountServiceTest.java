...
public class WordCountServiceTest {
    ...
    /**
     * This implementation doesn't know about placeholder. For now we count them
     * as word. We can do something more clever using an Okapi step later to
     * exclude them but this also make the services more complex.
     */
    @Test
    ...
    /**
     * Again complex message format returns a word count too high (9 instead of
     * 3) but this rare occurrence and the offset is acceptable.
     */
    @Test
    public void testGetEnglishWordCountComplexPlacehodler() {
        String string = "{numberOfSelectedRepositories, plural, =0{Repositories} =1{1 repository} other{# repositories}}";
        WordCountService instance = new WordCountService();
