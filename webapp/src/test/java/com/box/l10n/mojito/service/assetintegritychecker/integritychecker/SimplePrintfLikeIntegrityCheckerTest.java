...
public class SimplePrintfLikeIntegrityCheckerTest {
    ...
    @Test
    public void testPlaceholderAndTranslationCheckWorks() throws SimplePrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testTranslationAndPlaceholderCheckWorks() throws SimplePrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testPlaceholderCheckWorksWithDifferentOrder() throws SimplePrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testPlaceholderCheckFailsIfDifferentPlaceholdersCount() throws SimplePrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testPlaceholderCheckFailsIfSamePlaceholdersCountButSomeRepeatedOrMissing() throws SimplePrintfLikeIntegrityCheckerException {
    ...
    public void testWebappPlaceholderWithoutSpaces1() throws SimplePrintfLikeIntegrityCheckerException {
        ...
        String source = "%1Selecting 'All managed users' gives anyone in your organization the ability to invite groups to collaborate.%1";
        String target = "%1\"Все управляемые пользователи\" — все пользователи вашей организации могу приглашать группы для совместной работы.%1";
