...
public class SlaCheckerEmailServiceITest extends ServiceTestBase {
    ...
    public void testGetCloseIncidentEmailContent() throws IOException {
        ...
        // Files.write(email, new File("src/test/resources/com/box/l10n/mojito/service/sla/email/closeIncident.html"), StandardCharsets.UTF_8);
        String expected = Resources.toString(Resources.getResource("com/box/l10n/mojito/service/sla/email/closeIncident.html"), StandardCharsets.UTF_8);
    ...
    public void testGetOpenIncidentEmailContent() throws IOException {
        long incidentId = 0L;
        String email = slaCheckerEmailService.getOpenIncidentEmailContent(incidentId, getRepositoriesForTest());
        // Files.write(email, new File("src/test/resources/com/box/l10n/mojito/service/sla/email/openIncident.html"), StandardCharsets.UTF_8);
        String expected = Resources.toString(Resources.getResource("com/box/l10n/mojito/service/sla/email/openIncident.html"), StandardCharsets.UTF_8);
        assertEquals(expected, email);
    }
