...
public class AspectJUtilsTest {
  ...
  public void testFindAnnotatedMethodParam() throws NoSuchMethodException {
    AnnotatedMethodParam<ForTest> findAnnotatedMethodParam =
        aspectJUtils.findAnnotatedMethodParam(getJoinPointMock(), ForTest.class);
  ...
  public void testFindAnnotatedMethodParams() throws NoSuchMethodException {
    List<AnnotatedMethodParam<ForTest>> findAnnotatedMethodParams =
        aspectJUtils.findAnnotatedMethodParams(getJoinPointMock(), ForTest.class);
  ...
  private ProceedingJoinPoint getJoinPointMock() throws NoSuchMethodException {
    ...
    Mockito.when(signature.getMethod())
        .thenReturn(
            this.getClass().getMethod("annotatedFunction", String.class, Object.class, Long.class));
  ...
  public void annotatedFunction(
      @ForTest(name = "nameForTest") String s,
      Object skipped,
      @ForTest(name = "name2ForTest") Long l) {}
}
