...
public class PrefixHierarchicalNameMapperTest {
  ...
  public void toHierarchicalName() {
    ...
    Meter.Id id =
        new Meter.Id(
            "metric.name",
            Tags.of("tag1", "value1").and("tag2", "value2"),
            null,
            null,
            Meter.Type.COUNTER);
  ...
  public void toHierarchicalNameOverrideNameConvention() {
    ...
    Meter.Id id =
        new Meter.Id(
            "metric.name",
            Tags.of("tag.with.case.1", "value1").and("tag2", "value2"),
            null,
            null,
            Meter.Type.COUNTER);
    String hierarchicalName = mapper.toHierarchicalName(id, NamingConvention.camelCase);
  ...
  public void toHierarchicalNameOverrideTagCase() {
    ...
    Meter.Id id =
        new Meter.Id(
            "metric.name",
            Tags.of("tag.with.case1", "value1").and("tag2", "value2"),
            null,
            null,
            Meter.Type.COUNTER);
    String hierarchicalName = mapper.toHierarchicalName(id, NamingConvention.camelCase);
  ...
  public void toHierarchicalNamingConventionOnlyOnDottedInput() {
    ...
    Meter.Id id =
        new Meter.Id(
            "metricName",
            Tags.of("tagWithCase1", "value1").and("tag2", "value2"),
            null,
            null,
            Meter.Type.COUNTER);
    String hierarchicalName = mapper.toHierarchicalName(id, NamingConvention.camelCase);
  ...
  public void toHierarchicalNamingConventionStrippingCharacters() {
    stripCharacters = "{}$!@#";
    mapper =
        new PrefixHierarchicalNameMapper(
            "mojito", "_t_", stripCharacters, NamingConvention.snakeCase);
    Tags tags =
        Tags.of("tag#1", "value/{1}/.")
    ...
    assertEquals(
        "mojito.metricName._t_tag1.value/1/.._t_tag2.value2/test/value._t_tag3.value3/test._t_tag4.",
        hierarchicalName);
  }
  ...
  public void toHierarchicalNamingConventionStrippingCharactersRealTestCase() {
    ...
    assertEquals(
        "mojito.http_server_requests._t_status.200._t_uri./api/pollableTasks/pollableTaskId",
        name1);
    assertEquals(
        "mojito.http_server_requests._t_status.404._t_uri./api/assets/assetId/localized/localeId",
        name2);
  }
  ...
  public void stripCharacters() {
    ...
    PrefixHierarchicalNameMapper mapper1 =
        new PrefixHierarchicalNameMapper("prefix", "", null, NamingConvention.snakeCase);
    PrefixHierarchicalNameMapper mapper2 =
        new PrefixHierarchicalNameMapper("prefix", "", "", NamingConvention.snakeCase);
    PrefixHierarchicalNameMapper mapper3 =
        new PrefixHierarchicalNameMapper("prefix", "", "{}", NamingConvention.snakeCase);
    PrefixHierarchicalNameMapper mapper4 =
        new PrefixHierarchicalNameMapper("prefix", "", "$%", NamingConvention.snakeCase);
    PrefixHierarchicalNameMapper mapper5 =
        new PrefixHierarchicalNameMapper("prefix", "", "pre", NamingConvention.snakeCase);
