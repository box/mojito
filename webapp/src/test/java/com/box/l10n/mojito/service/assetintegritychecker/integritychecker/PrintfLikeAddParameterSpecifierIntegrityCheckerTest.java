...
public class PrintfLikeAddParameterSpecifierIntegrityCheckerTest {
     ...
     * logger
     */
    static Logger logger = LoggerFactory.getLogger(PrintfLikeAddParameterSpecifierIntegrityCheckerTest.class);

    @Test
    public void testGetPlaceholder() throws PrintfLikeIntegrityCheckerException {

        PrintfLikeAddParameterSpecifierIntegrityChecker checker = new PrintfLikeAddParameterSpecifierIntegrityChecker();
    ...
    @Test
    public void testMacPlaceholdersCheckWithRemovedSpacesWorks1() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testMacPlaceholdersCheckWithRemovedSpacesWorks2() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testMacMultiplePlaceholdersAndTranslationCheckWorks() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testMacTranslationAndMultiplePlaceholdersCheckWorks() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testMacPlaceholderCheckWorksWithDifferentOrder() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testMacPlaceholderCheckFailsIfDifferentPlaceholdersCount() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testMacPlaceholderCheckFailsIfSamePlaceholdersCountButSomeRepeatedOrMissing() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testMacPlaceholderCheckFailsIfSamePlaceholdersCountButSpecifierModified() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testAndroidMultiplePlaceholdersCheckWorks() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testAndroidMultiplePlaceholdersAndTranslationCheckWorks() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testAndroidTranslationAndMultiplePlaceholdersCheckWorks() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testAndroidPlaceholderCheckWorksWithDifferentOrder() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testAndroidPlaceholderCheckFailsIfDifferentPlaceholdersCount() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testAndroidPlaceholderCheckFailsIfSamePlaceholdersCountButSomeRepeatedOrMissing() throws PrintfLikeIntegrityCheckerException {
    ...
    @Test
    public void testAndroidPlaceholderCheckFailsIfSamePlaceholdersCountButSpecifierModified() throws PrintfLikeIntegrityCheckerException {
