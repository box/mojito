...
public class ImportTranslationsStepTest {
    ...
    public void testGetStatusWithSpecificImportStatus() {
        ...
        Mockito.when(target.getProperty(com.box.l10n.mojito.okapi.Property.STATE)).thenReturn(new net.sf.okapi.common.resource.Property("state", "doesnt matter"));
    ...
    public void testGetStatusFromStateTranslated() {
        ...
        TextContainer target = Mockito.mock(TextContainer.class);
        Mockito.when(target.getProperty(com.box.l10n.mojito.okapi.Property.STATE)).thenReturn(new net.sf.okapi.common.resource.Property("state", "translated"));
    ...
    public void testGetStatusFromStateSignedOff() {
        ...
        TextContainer target = Mockito.mock(TextContainer.class);
        Mockito.when(target.getProperty(com.box.l10n.mojito.okapi.Property.STATE)).thenReturn(new net.sf.okapi.common.resource.Property("state", "signed-off"));
    ...
    public void testGetStatusFromStateUnsupported() {
        ...
        TextContainer target = Mockito.mock(TextContainer.class);
        Mockito.when(target.getProperty(com.box.l10n.mojito.okapi.Property.STATE)).thenReturn(new net.sf.okapi.common.resource.Property("state", "unsupported"));
