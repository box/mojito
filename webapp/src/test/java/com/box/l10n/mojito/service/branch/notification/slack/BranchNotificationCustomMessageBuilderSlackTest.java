...
@SpringBootTest(classes = {
        ...
        ServerConfig.class},
        properties = {"l10n.branchNotification.slack.notification.message.new=Custom message text for new messages stating the time that screenshots need to be uploaded ",
...
public class BranchNotificationCustomMessageBuilderSlackTest {
    ...
    public void testGetNewMessage() {
        ...
        assertEquals("{\"channel\":\"channel-test\",\"text\":null,\"attachments\":[{\"title\":null,\"text\":\"Custom message text for new messages stating the time " +
    ...
    public void testGetTranslatedMessage() {
        ...
        String json = objectMapper.writeValueAsStringUnchecked(newMessage);
        assertEquals("{\"channel\":\"channel-test\",\"text\":\"Custom translations ready text\",\"attachments\":[],\"thread_ts\":\"pr-test\"}", json);
    }
    ...
    public void testGetScreenshotMissingMessage() {
        ...
        String json = objectMapper.writeValueAsStringUnchecked(newMessage);
        assertEquals("{\"channel\":\"channel-test\",\"text\":\"Custom screenshots missing text :warning:\",\"attachments\":[],\"thread_ts\":\"pr-test\"}", json);
    }
    ...
    public void testGetUpdatedMessage() {
        ...
        String json = objectMapper.writeValueAsStringUnchecked(newMessage);
        assertEquals("{\"channel\":\"channel-test\",\"text\":null,\"attachments\":[{\"title\":null,\"text\":\"Test custom message for update " +
    ...
    public void testGetUpdatedMessageNoMoreStrings() {
        ...
        String json = objectMapper.writeValueAsStringUnchecked(newMessage);
        assertEquals("{\"channel\":\"channel-test\",\"text\":\"Custom no more string message\",\"attachments\":[],\"thread_ts\":\"pr-test\"}", json);
    }
