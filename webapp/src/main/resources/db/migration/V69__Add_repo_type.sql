...
create table repo_type_integrity_checker (id bigint not null auto_increment, asset_extension varchar(255) not null, integrity_checker_type varchar(255) not null, repo_type_id bigint not null, primary key (id));
create index I__REPO_TYPE_INTEGRITY_CHECKER__REPO_TYPE_ID__ASSET_EXTENSION on repo_type_integrity_checker (repo_type_id, asset_extension);
