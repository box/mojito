...
let SearchText = createReactClass({
    ...
    getMessageForSearchAttribute(searchAttribute) {
        switch (searchAttribute) {
            ...
            case SearchParamsStore.SEARCH_ATTRIBUTES.TM_TEXT_UNIT_ID:
                return this.props.intl.formatMessage({id: "search.filter.tmTextUnitId"});
            case SearchParamsStore.SEARCH_ATTRIBUTES.LOCATION_USAGE:
                return this.props.intl.formatMessage({id: "search.filter.locationUsage"});
        }
    },
    ...
    renderDropdown() {
        return (
            <DropdownButton id="search-attribute-dropdown" title={this.getMessageForSearchAttribute(this.state.searchAttribute)}>
                ...
                {this.renderSearchAttributeMenuItem(SearchParamsStore.SEARCH_ATTRIBUTES.TM_TEXT_UNIT_ID)}
                {this.renderSearchAttributeMenuItem(SearchParamsStore.SEARCH_ATTRIBUTES.LOCATION_USAGE)}
                <MenuItem divider/>
