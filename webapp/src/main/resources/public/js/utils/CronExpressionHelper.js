export const validateCronExpression = (cron) => {
    ...
    const fieldDefs = [
        { name: 'Seconds',   re: /^([0-9]|[1-5][0-9])([,\-*/]([0-9]|[1-5][0-9]))*$/ },
        { name: 'Minutes',   re: /^([0-9]|[1-5][0-9])([,\-*/]([0-9]|[1-5][0-9]))*$/ },
        { name: 'Hours',     re: /^([01]?\d|2[0-3])([,\-*/]([01]?\d|2[0-3]))*$/ },
        { name: 'DayOfMonth',re: /^([1-9]|[12]\d|3[01]|\?|L|W)([,\-*/]([1-9]|[12]\d|3[01]|\?|L|W))*$/ },
        { name: 'Month',     re: /^(0?[0-9]|1[01]|JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC)([,\-*/](0?[0-9]|1[01]|JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC))*$/i },
