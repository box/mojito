...
public class FileSystemDropExporterConfigFromProperties {
  ...
  /**
   * Path on the file system where drops are exported, if not provided the exporter will use the
   * "fileSystemDropExporter" subdirectory in the current temporary directory.
   */
