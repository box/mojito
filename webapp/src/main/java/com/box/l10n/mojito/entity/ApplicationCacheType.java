...
/**
 * Entity to manage the different database-backed application cache instances/types. Application
 * cache entries {@link ApplicationCache} are always created against a specific cache type.
 *
 * @author garion
 */
@Entity
