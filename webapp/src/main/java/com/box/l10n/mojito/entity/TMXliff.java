...
public class TMXliff extends AuditableEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "asset_id", foreignKey = @ForeignKey(name = "FK__TM_XLIFF__ASSET__ID"), nullable = false)
    private Asset asset;
    ...
    @OneToOne
    @Basic(optional = true)
    @JoinColumn(name = "export_pollable_task_id", foreignKey = @ForeignKey(name = "FK__TM_XLIFF__EXPORT_POLLABLE_TASK__ID"))
