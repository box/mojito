...
/**
 * Validates that a variable format type is not modified in the target string, only validates
 * variables contained within brackets e.g.
 * %([variable_name])[flags][width][.precision][t]conversion)
 *
 * @author mallen
 */
