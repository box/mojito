...
public class RepositoryManualScreenshotRunJob implements Job {
  ...
  public JobDetailFactoryBean jobDetailRepositoryManualScreenshotRunJob() {
    ...
    jobDetailFactory.setDescription(
        "One time update of manual screenshot run on repository objects");
    jobDetailFactory.setDurability(true);
    return jobDetailFactory;
  }

  @Bean
  public SimpleTriggerFactoryBean triggerRepositoryManualScreenshotRunJob(
      @Qualifier("repositoryManualScreenshotRun") JobDetail job) {
