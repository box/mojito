 ...
 *
 * <p>This is required to re-compute OOSLA information. It will be also useful when adding new
 * statistics and have them recomputed automatically. Before we'd to wait for a change in the
 * repository.
 *
 * @author jaurambault
 */
...
public class RepositoryStatisticsCronJob implements Job {
  ...
  @Lazy @Autowired RepositoryStatisticsJobScheduler repositoryStatisticsJobScheduler;
  ...
  @Bean
  public CronTriggerFactoryBean triggerRepositoryStatisticsCron(
      @Qualifier("repositoryStatisticsCron") JobDetail job) {
