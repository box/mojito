...
/**
 * Performs leveraging based on the name of text units. The leveraged translations need to be
 * re-translated.
 *
 * <p>In other words, this will catch modification in the source text (and optionally in the
 * comments too).
 *
 * @author jaurambault
 */
