...
@Table(
        ...
        indexes = {
            @Index(name = "UK__PLURAL_FORM__PLURAL_FORM_ID__LOCALE_ID", columnList = "plural_form_id, locale_id", unique = true)
        }
)
public class PluralFormForLocale extends BaseEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "plural_form_id", foreignKey = @ForeignKey(name = "FK__PLURAL_FORM_FOR_LOCALE__PLURAL_FORM__ID"), nullable = false)
