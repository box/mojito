...
public class TextUnitDTONativeObjectMapper implements NativeObjectMapper<TextUnitDTO> {
    ...
    /**
     * Gets the status for the status string returned by the query. That
     * string can be null for text unit that maps to an untranslated string.
     * In that case the status will be {@link TMTextUnitVariant.Status.TRANSLATION_NEEDED} .
     *
