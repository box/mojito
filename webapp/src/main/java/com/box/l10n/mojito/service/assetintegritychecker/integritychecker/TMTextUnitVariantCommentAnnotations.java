...
/**
 * Helper class to manipulate {@link TMTextUnitVariantCommentAnnotation} on
 * a {@link TextContainer}.
 * 
 * @author jaurambault
 */
public class TMTextUnitVariantCommentAnnotations extends GenericAnnotations {
    ...
    /**
     * Creates an instance of the helper that will read/add annotations on the 
     * provided {@link TextContainer}.
     * 
    ...
    /**
     * Indicates if the {@link TextContainer} has at least one annotation with
     * an error.
     * 
    ...
    /**
     * Indicates if the {@link TextContainer} has at least one annotation with a
     * warning.
     * 
   ...
   /**
     ...
     * 
     * @return {@code true} if has at least one annotation with specified
     * severity else {@code false}
     */
    ...
    /**
     * Gets the {@link TMTextUnitVariantCommentAnnotation}s present on the 
     * {@link TextContainer}.
     * 
    ...
    public List<TMTextUnitVariantCommentAnnotation> getAnnotations() {
        ...
        TMTextUnitVariantCommentAnnotations tmTextUnitVariantCommentAnnotations = textContainer.getAnnotation(TMTextUnitVariantCommentAnnotations.class);

        if (tmTextUnitVariantCommentAnnotations != null) {
            for (GenericAnnotation allAnnotation : tmTextUnitVariantCommentAnnotations.getAllAnnotations()) {
    ...
    public void addAnnotation(TMTextUnitVariantCommentAnnotation tmTextUnitVariantCommentAnnotation) {
        ...
        TMTextUnitVariantCommentAnnotations current = textContainer.getAnnotation(TMTextUnitVariantCommentAnnotations.class);
