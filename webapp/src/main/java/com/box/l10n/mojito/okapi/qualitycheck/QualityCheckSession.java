...
/**
 * This class overrides the report generation behavior of the base QualityCheckSession. Because we
 * are only interested in getting the errors found, we don't need to generate any report.
 *
 * @author aloison
 */
public class QualityCheckSession extends net.sf.okapi.lib.verification.QualityCheckSession {
  ...
  protected List<Issue> getIssuesForTextUnit(ITextUnit textUnit) {
    ...
    Predicate<Issue> filterPredicate =
        new Predicate<Issue>() {
          @Override
