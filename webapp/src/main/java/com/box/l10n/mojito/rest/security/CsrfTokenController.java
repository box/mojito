...
/**
 * This endpoint is specifically created so that the CLI can easily get the token without parsing the html.
 * It is to the best of our knowledge not any worse than having the CSRF token embedded as an input field
 * of the html page.
 *
 * @author wyau
 */
