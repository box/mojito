...
/**
 * DTO that contains information about the current and exported (in a TranslationKit) {@link
 * TMTextUnitVariant}s for a {@link TMTextUnit}.
 *
 * <p>See {@link TranslationKitService#getTranslationKitExportedAndCurrentTUVs(java.lang.Long)}
 *
 * @author jaurambault
 */
public class TranslationKitExportedImportedAndCurrentTUV {
  ...
  public TranslationKitExportedImportedAndCurrentTUV(
      Long tmTextUnitId,
      Long exportedTmTextUnitVariant,
      Long importedTmTextUnitVariant,
      Long currentTmTextUnitVariant) {
