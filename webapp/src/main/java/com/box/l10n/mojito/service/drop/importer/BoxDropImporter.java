...
/**
 * A {@link DropImporter} that read content from Box, see related {@link BoxDropExporter}.
 *
 * @author jaurambault
 */
@Configurable
public class BoxDropImporter implements DropImporter {
   ...
   *
   * @param localizedFolderId id of the folder that contains the localized files to be imported
   */
