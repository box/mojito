...
public class BoxSDKServiceConfigFromProperties implements BoxSDKServiceConfig {
  ...
  /**
   * Use configuration from properties to configure the Box SDK client (else read configuration from
   * the database).
   */
   ...
   * files" folder because we don't want to pollute the real root folder. Instead all new folders
