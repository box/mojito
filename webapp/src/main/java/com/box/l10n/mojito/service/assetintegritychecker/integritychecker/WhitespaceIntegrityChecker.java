...
public class WhitespaceIntegrityChecker extends AbstractTextUnitIntegrityChecker {
  ...
  public void checkLeadingWhitespaces(String sourceContent, String targetContent)
      throws WhitespaceIntegrityCheckerException {
    ...
    if (!Objects.equal(sourceWhiteSpaces, targetWhiteSpaces)) {
      throw new WhitespaceIntegrityCheckerException(
          "Leading whitespaces around source and target are different");
    }
  }

  public void checkTrailingWhitespaces(String sourceContent, String targetContent)
      throws WhitespaceIntegrityCheckerException {
    ...
    if (!Objects.equal(sourceWhiteSpaces, targetWhiteSpaces)) {
      throw new WhitespaceIntegrityCheckerException(
          "Trailing shitespaces around source and target are different");
    }
  }
