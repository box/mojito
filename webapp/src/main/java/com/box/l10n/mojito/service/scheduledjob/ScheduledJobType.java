...
import com.box.l10n.mojito.service.scheduledjob.jobs.ScheduledEvolveSync;
...
public enum ScheduledJobType {
  ...
  EVOLVE_SYNC(ScheduledEvolveSync.class.getName(), ScheduledThirdPartySyncProperties.class);
