...
@NamedNativeQueries(
        @NamedNativeQuery(name = "TranslationKit.exportedAndCurrentTuvs",
                query
                = "select "
...
public class TranslationKit extends AuditableEntity {
    ...
    /**
     * Type of the translation kit to be created. Defines which content (text
     * units) will be included in the kit.
     *
     * @author jaurambault
     */
    public enum Type {
        ...
        /**
         * To create a kit for the translation process. it includes text units
         * with filter {@link StatusFilter#UNTRANSLATED_OR_TRANSLATION_NEEDED}
         */
        TRANSLATION,
        /**
         * To create a kit for the review process. It includes only text units
         * with filter {@link StatusFilter#REVIEW_NEEDED}
         */
        REVIEW
    }

    @OneToOne
    @JoinColumn(name = "locale_id", foreignKey = @ForeignKey(name = "FK__TRANSLATION_KIT__LOCALE__ID"))
