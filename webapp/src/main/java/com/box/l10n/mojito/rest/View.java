...
/**
 * This class is used with {@JsonView} to filter fields depending on the context of serialization to
 * avoid large payload.
 *
 * @author jyi
 */
public class View {
  ...
  public interface DropSummary
      extends IdAndNameAndCreated, LocaleSummary, PollableSummary, Pageable {}
