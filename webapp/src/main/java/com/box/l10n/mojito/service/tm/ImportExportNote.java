 ...
 *
 * <p>The note element is used to store different information and is used instead of some XLIFF
 * attributes because Okapi doesn't provide access to all of them.
 *
 * @author jaurambault
 */
