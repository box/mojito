...
/**
 * A {@link DropImporter} that read content from the local File system, see
 * related {@link FileSystemDropExporter}.
 *
 * @author jaurambault
 */
@Configurable
public class FileSystemDropImporter implements DropImporter {
     ...
     *
     * @param localizedFolderPath path of the folder that contains the localized
