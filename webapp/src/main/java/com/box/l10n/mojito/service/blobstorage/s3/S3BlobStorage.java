 ...
 * up will happen.
 *
 * <p>Objects will have a "retention" tag, see values in {@link Retention}
 *
 * <p>See https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lifecycle-mgmt.html for detail.
 *
 * <pre>
 * Overall steps are:
 *    - Add a lifecyle rule
...
public class S3BlobStorage implements BlobStorage {
  ...
  public Optional<String> getString(String name) {
    ...
    try {
      objectAsString =
          amazonS3.getObjectAsString(
              s3BlobStorageConfigurationProperties.getBucket(), getFullName(name));
    } catch (AmazonServiceException e) {
      if (!NO_SUCH_KEY.equals(e.getErrorCode())) {
        throw e;
      }
