...
/**
 * This is a copy of {@link net.sf.okapi.common.filterwriter.XLIFFWriter} and
 * must be updated when updating Okapi.
 * 
...
public class XLIFFWriter implements IFilterWriter {
		...
		String phaseName)
	{
			...
			if ( outputTarget ) {
				...
				writer.writeAttributeString("xml:lang", trgLoc.toBCP47());
                                ...
                                if (tu.hasTargetProperty(trgLoc, com.box.l10n.mojito.okapi.Property.STATE)) {
                                    String state = tu.getTargetProperty(trgLoc, com.box.l10n.mojito.okapi.Property.STATE).getValue(); 
		...
		if ( tu.hasProperty(Property.TRANSNOTE) ) {
			...
			writer.writeString(tu.getProperty(com.box.l10n.mojito.okapi.Property.TARGET_COMMENT).getValue());
			writer.writeEndElementLineBreak(); 
		}
