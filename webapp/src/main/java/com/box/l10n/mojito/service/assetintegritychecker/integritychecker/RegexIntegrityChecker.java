...
/**
 * Checks that there are the same placeholders in the source and target content, order is not
 * important. Placeholders are extracted using a regular expression.
 *
 * @author wyau
 */
