...
/**
 * Implementing this interface allows an object to be used to export {@link Drop}s.
 *
 * <p>DropExporter instance should be re-creatable from a configuration string. See {@link
 * DropExporterService#createDropExporterAndUpdateDrop(com.box.l10n.mojito.entity.Drop,
 * com.box.l10n.mojito.entity.PollableTask) } and {@link
 * DropExporterService#recreateDropExporter(com.box.l10n.mojito.entity.Drop) }
 *
...
public interface DropExporter {
   ...
   *
   * <p>The configuration must contain enough information to re-create a fully workable instance,
   * using {@link #setConfig(java.lang.String) } followed by {@link
   * #init(com.box.l10n.mojito.entity.PollableTask, com.box.l10n.mojito.entity.PollableTask) }.
   *
   * <p>The configuration can any semi-structured data and is up to the implementation
   *
  ...
  /**
   * Initialize the DropExporter (for example, an implementation could prepare the target location
   * by creating directories where the drop files will be store).
   *
   * <p>Optionally use {@link #getConfig() } to initialize the instance.
   *
   * <p>Once the instance is initialized, {@link #getConfig()} must return enough information to
   * fully re-create a new instance of the exporter equivalent to the current instance.
   *
  ...
  /**
   * Exports a source file via the {@link DropExporter}. The file content is assumed to be XLIFF.
   *
  ...
  /**
   * Exports an "imported" file (a localized file that was imported and that contains meta
   * information about the import process). This file can be used to review what text unit were
   * saved or skipped.
   *
   ...
   */
  void exportImportedFile(String filename, String fileContent, String comment)
      throws DropExporterException;
  ...
  /**
   * Returns an {@link DropImporter} to read localized files corresponding to source files exported
   * using this exporter (or a re-created exporter).
   *
   * @return
   */
