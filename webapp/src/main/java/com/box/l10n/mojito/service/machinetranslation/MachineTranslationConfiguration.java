...
/**
 * Configures the implementation for {@link MachineTranslationEngine}
 * The default implementation is the {@link NoOpEngine} which is a stub.
 * Consider implementing & configuring an actual MT Engine using the "l10n.mt.impl" property.
 *
 * @author garion
 */
@Configuration
