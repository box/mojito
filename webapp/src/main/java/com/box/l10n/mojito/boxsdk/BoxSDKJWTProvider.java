...
public class BoxSDKJWTProvider {
     ...
     */
    public JWTEncryptionPreferences getJWTEncryptionPreferences(BoxSDKServiceConfig boxSDKServiceConfig) {
     ...
     * @throws BoxSDKServiceException
     */
    public JWTEncryptionPreferences getJWTEncryptionPreferences(String publicKeyId,
