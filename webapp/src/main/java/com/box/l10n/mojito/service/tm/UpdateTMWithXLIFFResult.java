...
public class UpdateTMWithXLIFFResult {
  ...
  /**
   * An optional comment regarding the whole XLIFF file. Usually contains message indicating there
   * was an issue during import and that the file needs to be reviewed.
   */
  String comment;
