...
//
//    final LeveragerByContent leveragerByContent;
//
...
//        this.leveragerByContent = leveragerByContent;
...
//    }
//
//    private ImmutableMap<String, TextUnitDTO> getMostRecentTranslationsByLanguage(ArrayList<Long> repositoryIds, ArrayList<String> repositoryNames, String sourceText) {
//        List<TextUnitDTO> textUnitDTOsForLeveraging = getLeveragedTextUnitDTOS(sourceText, repositoryIds, repositoryNames);
//
//        Comparator<TextUnitDTO> tmTextUnitCreatedDateComparator = Comparator.comparing(TextUnitDTO::getTmTextUnitCreatedDate);
//
...
//                        Function.identity(),
//                        BinaryOperator.maxBy(tmTextUnitCreatedDateComparator)));
//    }
//
//    List<TextUnitDTO> getLeveragedTextUnitDTOS(String sourceText, ArrayList<Long> repositoryIds, ArrayList<String> repositoryNames) {
//        TMTextUnit searchTmTextUnit = new TMTextUnit();
//        searchTmTextUnit.setContent(sourceText);
//
//        return leveragerByContent.getLeveragingMatchesForRepository(searchTmTextUnit, null, repositoryIds, repositoryNames);
//    }
//
