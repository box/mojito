...
/**
 * Configuration for the tiered cache for the MachineTranslation service. The second tier cache
 * (database) is optional and can be enabled/disabled. By default, the TTL is 0 (disabled).
 *
 * @author garion
 */
@Configuration
