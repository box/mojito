...
/**
 * Copy of {@link Timed} for CTW, see: https://github.com/micrometer-metrics/micrometer/issues/1149
 */
@Aspect
public class TimedAspect {
  ...
  public Object timedMethod(ProceedingJoinPoint pjp) throws Throwable {
    ...
    final boolean stopWhenCompleted =
  ...
  private Object processWithTimer(
      ProceedingJoinPoint pjp, Timed timed, String metricName, boolean stopWhenCompleted)
      throws Throwable {
  ...
  private Object processWithLongTaskTimer(
    ...
    Optional<LongTaskTimer.Sample> sample =
        buildLongTaskTimer(pjp, timed, metricName).map(LongTaskTimer::start);
  ...
  private Optional<LongTaskTimer> buildLongTaskTimer(
      ProceedingJoinPoint pjp, Timed timed, String metricName) {
    try {
      return Optional.of(
