...
/**
 * Performs leveraging based on the content of text units. The leveraged translations don't need to
 * be re-translated.
 *
 * <p>In other words, this will catch modification to the name (and optionally in the comments too).
 *
 * @author jaurambault
 */
@Component
