...
public class LocalBranchToEntityBranchConverter {
    ...
    public static final DateTime NULL_BRANCH_DATE_PLACEHODLER = new DateTime(Instant.EPOCH.toEpochMilli());
    ...
    public String branchEntityToLocalBranchName(com.box.l10n.mojito.entity.Branch branch) {
        return branch == null ? NULL_BRANCH_TEXT_PLACEHOLDER :
    ...
    public Branch convertEntityBranchToLocaleBranch(com.box.l10n.mojito.entity.Branch b) {
        ...
        if (b == null) {
            ...
            DateTime createdDate = b.getCreatedDate() != null ? b.getCreatedDate() : NULL_BRANCH_DATE_PLACEHODLER;
