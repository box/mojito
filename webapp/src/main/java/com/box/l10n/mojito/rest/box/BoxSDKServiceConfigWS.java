...
public class BoxSDKServiceConfigWS {
  ...
  public List<BoxSDKServiceConfigEntity> getBoxSDKServiceConfig() {
    ...
    BoxSDKServiceConfigEntity boxSDKServiceConfigEntity =
        boxSDKServiceConfigEntityService.getBoxSDKServiceConfigEntity();
  ...
  public ResponseEntity setBoxSDKServiceConfig(@RequestBody BoxSDKServiceConfigEntity config) {
    try {
      ...
      if (!config.getBootstrap()) {
        boxSDKServiceConfigEntityPollableFuture =
            boxSDKServiceConfigEntityService.addConfigWithNoBootstrap(
                config.getClientId(),
