...
public class BoxSDKServiceConfigEntity extends AuditableEntity implements BoxSDKServiceConfig {
  ...
  /**
   * Bootstraping allows Mojito to set up the Box folder structures in prepartion for project
  ...
  public boolean equals(Object o) {
    ...
    if (clientSecret != null ? !clientSecret.equals(that.clientSecret) : that.clientSecret != null)
      return false;
    if (publicKeyId != null ? !publicKeyId.equals(that.publicKeyId) : that.publicKeyId != null)
      return false;
    if (privateKey != null ? !privateKey.equals(that.privateKey) : that.privateKey != null)
      return false;
    if (privateKeyPassword != null
        ? !privateKeyPassword.equals(that.privateKeyPassword)
        : that.privateKeyPassword != null) return false;
    ...
    if (appUserId != null ? !appUserId.equals(that.appUserId) : that.appUserId != null)
      return false;
    if (rootFolderId != null ? !rootFolderId.equals(that.rootFolderId) : that.rootFolderId != null)
      return false;
    if (rootFolderUrl != null
        ? !rootFolderUrl.equals(that.rootFolderUrl)
        : that.rootFolderUrl != null) return false;
    if (dropsFolderId != null
        ? !dropsFolderId.equals(that.dropsFolderId)
        : that.dropsFolderId != null) return false;
