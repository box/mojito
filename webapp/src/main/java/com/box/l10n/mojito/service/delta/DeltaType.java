...
/**
 * Types that classify if the deltas provide a new translation, an updated translation or if that
 * information is unknown, with a corresponding priority associated.
 *
 * @author garion
 */
