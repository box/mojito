...
/**
 * Configuration settings for the Microsoft Machine Translation client.
 * Only used when "l10n.mt.impl" has the "MicrosoftMTEngine" value and the
 * subscription key is provided in the "l10n.microsoft-mt.subscriptionKey" property.
 *
 * @author garion
 */
@Component
