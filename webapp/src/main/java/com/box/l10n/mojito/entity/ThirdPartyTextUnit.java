...
@Table(
        ...
        indexes = {
                @Index(name = "UK__THIRD_PARTY_TEXT_UNIT__TM_TEXT_UNIT_ID", columnList = "tm_text_unit_id", unique = true)
        }
)
public class ThirdPartyTextUnit extends AuditableEntity {
    ...
    @JoinColumn(name = "asset_id", foreignKey = @ForeignKey(name = "FK__THIRD_PARTY_TEXT_UNIT__ASSET__ID"))
    Asset asset;
