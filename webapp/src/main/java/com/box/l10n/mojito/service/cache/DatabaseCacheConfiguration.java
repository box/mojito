...
/**
 * This class enables custom configurations for a database-backed cache. By default, no TTL is
 * configured (an expiry date isn't writen for entries). Cache evictions is done by {@Link
 * DatabaseCacheEvictionJob}. The serializer and deserializers for the keys and values are also
 * configurable.
 *
 * @author garion
 */
