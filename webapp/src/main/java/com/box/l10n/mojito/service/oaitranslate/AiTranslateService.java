...
public class AiTranslateService {
  ...
  public PollableFuture<Void> aiTranslateAsync(long repositoryId) {

    QuartzJobInfo<AiTranslateJob.AiTranslateJobInput, Void> quartzJobInfo =
        QuartzJobInfo.newBuilder(AiTranslateJob.class)
            .withInlineInput(false)
            .withInput(new AiTranslateJob.AiTranslateJobInput(repositoryId))
  ...
  public void aiTranslate(long repositoryId) {
            ...
            .orElseThrow(
                () ->
                    new RuntimeException(
                        "Must have a valid repository id, provided: " + repositoryId));
    ...
    ArrayDeque<CreateBatchResponse> batches =
        repositoryLocalesWithoutRootLocale.stream()
            .map(createBatchForRepositoryLocale(repository))
  ...
  Function<RepositoryLocale, CreateBatchResponse> createBatchForRepositoryLocale(
    ...
    return repositoryLocale -> {
      ...
      return openAIClient.createBatch(
          forChatCompletion(
    ...
    return textUnitDTOS.stream()
        .map(
            textUnitDTO -> {
              ...
              String inputAsJsonString = objectMapper.writeValueAsStringUnchecked(aiTranslateInput);
  ...
  RetrieveBatchResponse retrieveBatchWithRetry(CreateBatchResponse batch) {
    ...
    return Mono.fromCallable(() -> openAIClient.retrieveBatch(new RetrieveBatchRequest(batch.id())))
        .retryWhen(
  ...
  record AiTranslateInput(String locale, String source, String sourceDescription) {}
