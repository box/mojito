...
public class AspectJUtils {
     ...
     */
    public <T extends Annotation> AnnotatedMethodParam<T> findAnnotatedMethodParam(ProceedingJoinPoint pjp, Class<T> searchedAnnotation) {
        AnnotatedMethodParam<T> res = null;

        List<AnnotatedMethodParam<T>> annotatedMethodParams = AspectJUtils.this.findAnnotatedMethodParams(pjp, searchedAnnotation, true);
     ...
     */
    public <T extends Annotation> List<AnnotatedMethodParam<T>> findAnnotatedMethodParams(ProceedingJoinPoint pjp, Class<T> searchedAnnotation) {
