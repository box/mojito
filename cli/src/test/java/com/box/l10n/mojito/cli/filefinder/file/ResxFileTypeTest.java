...
public class ResxFileTypeTest {
  ...
  public void testTargetPattern() {
    ResxFileType resxFileType = new ResxFileType();
    Matcher matcher =
        resxFileType.getTargetFilePattern().getPattern().matcher("/source/Filefinder.fr.resx");
    Assert.assertTrue(matcher.matches());
  ...
  public void testTargetPatternBcp47() {
    ResxFileType resxFileType = new ResxFileType();
    Matcher matcher =
        resxFileType.getTargetFilePattern().getPattern().matcher("/source/Filefinder.en-GB.resx");
    Assert.assertTrue(matcher.matches());
