...
public class MacStringsdictFileTypeTest {
    ...
    public void testSourcePattern() {
        ...
        Matcher matcher = sourceFilePattern.getPattern().matcher("/source/en.lproj/Localizable.stringsdict");
    ...
    public void testSourcePatternNoMatch() {
        MacStringsdictFileType macStringsdictFileType = new MacStringsdictFileType();
        FilePattern sourceFilePattern = macStringsdictFileType.getSourceFilePattern();
        Matcher matcher = sourceFilePattern.getPattern().matcher("/source/fr.lproj/Localizable.stringsdict");
    ...
    public void testTargetPattern() {
        MacStringsdictFileType macStringsdictFileType = new MacStringsdictFileType();
        Matcher matcher = macStringsdictFileType.getTargetFilePattern().getPattern().matcher("/source/fr.lproj/Localizable.stringsdict");
        Assert.assertTrue(matcher.matches());
        Assert.assertEquals("/source/", matcher.group(PARENT_PATH));
    ...
    public void testTargetPatternBcp47() {
        MacStringsdictFileType macStringsdictFileType = new MacStringsdictFileType();
        Matcher matcher = macStringsdictFileType.getTargetFilePattern().getPattern().matcher("/source/en-GB.lproj/Localizable.stringsdict");
        Assert.assertTrue(matcher.matches());
        Assert.assertEquals("/source/", matcher.group(PARENT_PATH));
    ...
    public void testTargetPatternNoMatch() {
        MacStringsdictFileType macStringsdictFileType = new MacStringsdictFileType();
        Matcher matcher = macStringsdictFileType.getTargetFilePattern().getPattern().matcher("/source/en.lproj/Localizable.stringsdict");
        Assert.assertFalse(matcher.matches());
    }
