...
public class UserDeleteCommandTest extends CLITestBase {
    ...
    public void testDelete() {
        ...
        assertTrue("User is not deleted successfully", outputCapture.toString().contains("deleted --> user:"));
    }
    ...
    public void testDeleteNonExistingUser() {
        ...
        assertTrue(outputCapture.toString().contains("User with username [" + username + "] is not found"));
    }
}
