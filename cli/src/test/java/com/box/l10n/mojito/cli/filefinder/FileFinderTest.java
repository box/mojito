...
public class FileFinderTest extends IOTestBase {
  ...
  public void findProperties() throws IOException, FileFinderException {
    ...
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/filefinder.properties",
        next.getPath().toString());
    assertEquals("filefinder_fr_FR.properties", next.getTargetPath("fr_FR"));

    next = itSources.next();
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/sub/filefinder2.properties",
        next.getPath().toString());
    ...
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/filefinder_fr.properties",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/filefinder_fr_FR.properties",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/sub/filefinder2_fr.properties",
        itTargets.next().getPath().toString());
  ...
  public void findPropertiesNoBasename() throws IOException, FileFinderException {
    ...
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/en.properties",
        next.getPath().toString());
    assertEquals("fr-FR.properties", next.getTargetPath("fr-FR"));

    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/fr-FR.properties",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/fr.properties",
        itTargets.next().getPath().toString());
  ...
  public void findPropertiesNoBasenameEnUs() throws IOException, FileFinderException {
    ...
    FileMatch next = itSources.next();
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/en-US.properties",
        next.getPath().toString());
    assertEquals(PropertiesNoBasenameFileType.class, next.fileType.getClass());
    assertEquals("fr-FR.properties", next.getTargetPath("fr-FR"));
  ...
  public void findXliff() throws IOException, FileFinderException {
    ...
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/filefinder.xliff",
        next.getPath().toString());
    assertEquals("filefinder_fr-FR.xliff", next.getTargetPath("fr-FR"));

    next = itSources.next();
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/sub/filefinder2.xliff",
        next.getPath().toString());
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/filefinder_fr-FR.xliff",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/filefinder_fr.xliff",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/sub/filefinder2_fr.xliff",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findXcodeXliff() throws IOException, FileFinderException {
    ...
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/en.xliff", next.getPath().toString());
    assertEquals("fr.xliff", next.getTargetPath("fr"));

    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/fr.xliff",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/ko.xliff",
        itTargets.next().getPath().toString());
  ...
  public void findInSameDirectory() throws FileFinderException {
    ...
    Iterator<FileMatch> itSources = fileFinder.getSources().iterator();
    assertEquals(
        getInputResourcesTestDir().toString() + "/filefinder.properties",
        itSources.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/sub/filefinder2.properties",
        itSources.next().getPath().toString());
    assertFalse(itSources.hasNext());

    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir().toString() + "/filefinder_en.properties",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/filefinder_fr.properties",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/filefinder_fr_FR.properties",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/sub/filefinder2_fr.properties",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findResw() throws IOException, FileFinderException {
    ...
    FileMatch next = itSources.next();
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/en/Resources.resw",
        next.getPath().toString());
    assertEquals("fr/Resources.resw", next.getTargetPath("fr"));

    next = itSources.next();
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/en/Resources2.resw",
        next.getPath().toString());
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/en-GB/Resources.resw",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/fr/Resources.resw",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/fr/Resources2.resw",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findReswInSameDirectory() throws IOException, FileFinderException {
    ...
    FileMatch next = itSources.next();
    assertEquals(
        getInputResourcesTestDir().toString() + "/en/Resources.resw", next.getPath().toString());
    assertEquals("fr/Resources.resw", next.getTargetPath("fr"));

    next = itSources.next();
    assertEquals(
        getInputResourcesTestDir().toString() + "/en/Resources2.resw", next.getPath().toString());
    assertEquals("fr/Resources2.resw", next.getTargetPath("fr"));
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir().toString() + "/en-GB/Resources.resw",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/fr/Resources.resw",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/fr/Resources2.resw",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findResx() throws IOException, FileFinderException {
    ...
    FileMatch next = itSources.next();
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/FileFinder1.resx",
        next.getPath().toString());
    assertEquals("FileFinder1.fr.resx", next.getTargetPath("fr"));

    next = itSources.next();
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/sub/FileFinder2.resx",
        next.getPath().toString());
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/FileFinder1.en-GB.resx",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/FileFinder1.fr.resx",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/sub/FileFinder2.fr.resx",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findResxInSameDirectory() throws IOException, FileFinderException {
    ...
    FileMatch next = itSources.next();
    assertEquals(
        getInputResourcesTestDir().toString() + "/FileFinder1.resx", next.getPath().toString());
    assertEquals("FileFinder1.fr.resx", next.getTargetPath("fr"));

    next = itSources.next();
    assertEquals(
        getInputResourcesTestDir().toString() + "/FileFinder2.resx", next.getPath().toString());
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir().toString() + "/FileFinder1.en-GB.resx",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/FileFinder1.fr.resx",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/FileFinder2.fr.resx",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findResxWithSourceRegex() throws IOException, FileFinderException {
    ...
    FileMatch next = itSources.next();
    assertEquals(
        getInputResourcesTestDir().toString() + "/sub1/Localization/Resources.resx",
        next.getPath().toString());
    assertEquals("sub1/Localization/Resources.fr.resx", next.getTargetPath("fr"));

    next = itSources.next();
    assertEquals(
        getInputResourcesTestDir().toString() + "/sub2/Localization/Resources.resx",
        next.getPath().toString());
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir().toString() + "/sub1/Localization/Resources.en-GB.resx",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/sub1/Localization/Resources.fr.resx",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/sub2/Localization/Resources.fr.resx",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findMacStrings() throws IOException, FileFinderException {
    ...
    FileMatch next = itSources.next();
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/en.lproj/InfoPlist.strings",
        next.getPath().toString());
    assertEquals("fr.lproj/InfoPlist.strings", next.getTargetPath("fr"));

    next = itSources.next();
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/en.lproj/Localizable.strings",
        next.getPath().toString());
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/en-GB.lproj/InfoPlist.strings",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/en-GB.lproj/Localizable.strings",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/fr.lproj/InfoPlist.strings",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/fr.lproj/Localizable.strings",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findMacStringsInSameDirectory() throws IOException, FileFinderException {
    ...
    FileMatch next = itSources.next();
    assertEquals(
        getInputResourcesTestDir().toString() + "/en.lproj/InfoPlist.strings",
        next.getPath().toString());
    assertEquals("fr.lproj/InfoPlist.strings", next.getTargetPath("fr"));

    next = itSources.next();
    assertEquals(
        getInputResourcesTestDir().toString() + "/en.lproj/Localizable.strings",
        next.getPath().toString());
    assertEquals("fr.lproj/Localizable.strings", next.getTargetPath("fr"));
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir().toString() + "/en-GB.lproj/InfoPlist.strings",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/en-GB.lproj/Localizable.strings",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/fr.lproj/InfoPlist.strings",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/fr.lproj/Localizable.strings",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findMacStringsdict() throws IOException, FileFinderException {
    ...
    FileMatch next = itSources.next();
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/en.lproj/Localizable.stringsdict",
        next.getPath().toString());
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/en-GB.lproj/Localizable.stringsdict",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/fr.lproj/Localizable.stringsdict",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findMacStringsdictInSameDirectory() throws IOException, FileFinderException {
    ...
    FileMatch next = itSources.next();
    assertEquals(
        getInputResourcesTestDir().toString() + "/en.lproj/Localizable.stringsdict",
        next.getPath().toString());
    assertEquals("fr.lproj/Localizable.stringsdict", next.getTargetPath("fr"));
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir().toString() + "/en-GB.lproj/Localizable.stringsdict",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/fr.lproj/Localizable.stringsdict",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findAndroidStrings() throws IOException, FileFinderException {
    ...
    FileMatch next = itSources.next();
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/res/values/strings.xml",
        next.getPath().toString());
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/res/values-en-rGB/strings.xml",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/res/values-fr/strings.xml",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findAndroidStringsInSameDirectory() throws IOException, FileFinderException {
    ...
    FileMatch next = itSources.next();
    assertEquals(
        getInputResourcesTestDir().toString() + "/res/values/strings.xml",
        next.getPath().toString());
    assertEquals("res/values-fr/strings.xml", next.getTargetPath("fr"));
    assertEquals("res/values-en-rGB/strings.xml", next.getTargetPath("en-GB"));
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir().toString() + "/res/values-en-rGB/strings.xml",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/res/values-fr/strings.xml",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findXtb() throws IOException, FileFinderException {
    ...
    FileMatch next = itSources.next();
    assertEquals(
        getInputResourcesTestDir().toString() + "/FileFinder1-en-US.xtb",
        next.getPath().toString());
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir().toString() + "/FileFinder1-en-GB.xtb",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/FileFinder1-fr.xtb",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findCsv() throws IOException, FileFinderException {
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir().toString() + "/demo_en-GB.csv",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/demo_fr-FR.csv",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findJS() throws IOException, FileFinderException {
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir().toString() + "/en-GB.js", itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/fr-FR.js", itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findTS() throws IOException, FileFinderException {
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir().toString() + "/en-GB.ts", itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir().toString() + "/fr-FR.ts", itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findJSON() throws IOException, FileFinderException {
    ...
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/filefinder.json",
        next.getPath().toString());
    assertEquals("filefinder_fr-FR.json", next.getTargetPath("fr-FR"));

    next = itSources.next();
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/sub/filefinder2.json",
        next.getPath().toString());
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/filefinder_fr-FR.json",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/filefinder_fr.json",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/sub/filefinder2_fr.json",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  public void findJSONNoBasename() throws IOException, FileFinderException {
    ...
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/en.json", next.getPath().toString());
    assertEquals("fr-FR.json", next.getTargetPath("fr-FR"));

    next = itSources.next();
    assertEquals(
        getInputResourcesTestDir("source").toString() + "/sub/en.json", next.getPath().toString());
    ...
    Iterator<FileMatch> itTargets = fileFinder.getTargets().iterator();
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/fr-FR.json",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/fr.json",
        itTargets.next().getPath().toString());
    assertEquals(
        getInputResourcesTestDir("target").toString() + "/sub/fr.json",
        itTargets.next().getPath().toString());
    assertFalse(itTargets.hasNext());
  }
  ...
  FileFinder initFileFinder(
      boolean targetSameAsSourceDirectory, String sourcePathFilterRegex, FileType... fileTypes)
      throws FileFinderException {
