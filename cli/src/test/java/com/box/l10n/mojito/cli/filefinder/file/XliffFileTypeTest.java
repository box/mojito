...
public class XliffFileTypeTest {
    ...
    public void testTargetPattern() {
        XliffFileType xliffFileType = new XliffFileType();
        Matcher matcher = xliffFileType.getTargetFilePattern().getPattern().matcher("/source/filefinder_fr.xliff");
        Assert.assertTrue(matcher.matches());
    ...
    public void testTargetPatternBcp47() {
        XliffFileType xliffFileType = new XliffFileType();
        Matcher matcher = xliffFileType.getTargetFilePattern().getPattern().matcher("/source/filefinder_fr-FR.xliff");
        Assert.assertTrue(matcher.matches());
