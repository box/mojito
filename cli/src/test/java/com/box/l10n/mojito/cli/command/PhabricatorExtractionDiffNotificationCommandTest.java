...
public class PhabricatorExtractionDiffNotificationCommandTest extends CLITestBase {
  ...
  public void getMessageInfo() {
    PhabricatorExtractionDiffNotificationCommand phabricatorExtractionDiffNotificationCommand =
        new PhabricatorExtractionDiffNotificationCommand();
    phabricatorExtractionDiffNotificationCommand.phabricatorMessageBuilder =
        new PhabricatorMessageBuilder();
    assertEquals(
  ...
  public void withTemplate() {
    ...
    phabricatorExtractionDiffNotificationCommand.phabricatorMessageBuilder =
        new PhabricatorMessageBuilder();
    phabricatorExtractionDiffNotificationCommand.messageTemplate =
  ...
  public void shouldSendNotification() {
    ...
    phabricatorExtractionDiffNotificationCommand.phabricatorMessageBuilder =
        new PhabricatorMessageBuilder();
    assertTrue(
        phabricatorExtractionDiffNotificationCommand.shouldSendNotification(
            ExtractionDiffStatistics.builder()
                .added(0)
                .removed(200)
                .base(500)
  ...
  public void sendNotification() throws Exception {
    ...
    PhabricatorExtractionDiffNotificationCommand command =
        l10nJCommander.getCommand(PhabricatorExtractionDiffNotificationCommand.class);
