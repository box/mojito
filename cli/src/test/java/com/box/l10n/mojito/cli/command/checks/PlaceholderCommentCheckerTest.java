...
public class PlaceholderCommentCheckerTest {
  ...
  public void testOneOfMultiplePlaceholderDescriptionsMissingInComment() {
    ...
    Assert.assertFalse(result.isHardFail());
    Assert.assertEquals(
        "Placeholder description in comment check failed."
    ...
    placeholderCommentChecker.setCliCheckerOptions(
        new CliCheckerOptions(
            Sets.newHashSet(
                ...
                PLACEHOLDER_NO_SPECIFIER_REGEX),
            Sets.newHashSet(),
            ImmutableMap.<String, String>builder().build()));
    List<AssetExtractorTextUnit> addedTUs = new ArrayList<>();
    AssetExtractorTextUnit assetExtractorTextUnit = new AssetExtractorTextUnit();
    assetExtractorTextUnit.setSource(
        "A source string with different {placeholder} %(placeholder2)s {{placeholder3}} %d");
    assetExtractorTextUnit.setComments(
        "Test comment placeholder:A description of placeholder,placeholder2: Another description,%d:some more,placeholder3: another description");
    addedTUs.add(assetExtractorTextUnit);
    List<AssetExtractionDiff> assetExtractionDiffs = new ArrayList<>();
    AssetExtractionDiff assetExtractionDiff = new AssetExtractionDiff();
    assetExtractionDiff.setAddedTextunits(addedTUs);
  ...
  public void testMultipleRegexsCheckedFailure() {
    ...
    assetExtractorTextUnit.setSource(
        "A source string with different {placeholder} %(placeholder2)s {{placeholder3}} %d");
    assetExtractorTextUnit.setComments(
        "Test comment placeholder:A description of placeholder,placeholder3: another description");
    addedTUs.add(assetExtractorTextUnit);
    List<AssetExtractionDiff> assetExtractionDiffs = new ArrayList<>();
    AssetExtractionDiff assetExtractionDiff = new AssetExtractionDiff();
    assetExtractionDiff.setAddedTextunits(addedTUs);
  ...
  public void testMultipleIOSPlaceholderTypes() {
    ...
    assetExtractorTextUnit.setSource("A source string with a single %1$@ %@ %2$@ld");
    assetExtractorTextUnit.setComments(
        "Test comment %1$@:A placeholder description, %@:Another placeholder description, %2$@ld: And another description");
    addedTUs.add(assetExtractorTextUnit);
    List<AssetExtractionDiff> assetExtractionDiffs = new ArrayList<>();
    AssetExtractionDiff assetExtractionDiff = new AssetExtractionDiff();
    assetExtractionDiff.setAddedTextunits(addedTUs);
