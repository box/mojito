...
public class TMImportCommandTest extends CLITestBase {
    ...
    public void testImport() throws Exception {
        ...
        List<TMTextUnitVariant> tmTextUnitsVariantsJapanese = tmTextUnitVariantRepository.findAllByLocale_IdAndTmTextUnit_Tm_id(locale.getId(), tmId);
    ...
    public void testImportWithImportExportNote() throws Exception {
        ...
        Set<TMTextUnitVariantComment> tmTextUnitVariantComments = tmTextUnitVariant.getTmTextUnitVariantComments();
        for (TMTextUnitVariantComment tmTextUnitVariantComment : tmTextUnitVariantComments) {
            assertEquals("User should be set to the current user doing the import", bootstrapConfig.getDefaultUser().getUsername(), tmTextUnitVariantComment.getCreatedByUser().getUsername());
        }
    ...
    private void sortTMTextUnitVariantByContent(List<TMTextUnitVariant> textUnitVariants) {
        Collections.sort(textUnitVariants, new Comparator<TMTextUnitVariant>() {
    ...
    private Locale getLocaleFromRepositoryLocales(Set<RepositoryLocale> repositoryLocales, String bcp47Tag) {
