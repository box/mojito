...
public class PhabricatorDiffInfoCommandTest {
    ...
    public void testCheckWithPhabricatorOverride() {
        ...
        verify(differentialRevisionMock, times(1)).addComment("D123456", PhabricatorDiffInfoCommand.PHAB_OVERRIDE_MESSAGE);
    }
    ...
    public void testCheckWithNoPhabricatorOverride() {
        ...
        verify(differentialRevisionMock, times(0)).addComment("D123456", PhabricatorDiffInfoCommand.PHAB_OVERRIDE_MESSAGE);
    }
}
