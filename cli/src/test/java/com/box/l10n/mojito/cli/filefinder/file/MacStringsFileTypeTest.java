...
public class MacStringsFileTypeTest {
    ...
    public void testSourcePattern() {
        ...
        Matcher matcher = sourceFilePattern.getPattern().matcher("/source/en.lproj/Localizable.strings");
    ...
    public void testSourcePatternNoMatch() {
        MacStringsFileType macStringsFileType = new MacStringsFileType();
        FilePattern sourceFilePattern = macStringsFileType.getSourceFilePattern();
        Matcher matcher = sourceFilePattern.getPattern().matcher("/source/fr.lproj/Localizable.strings");
    ...
    public void testTargetPattern() {
        MacStringsFileType macStringsFileType = new MacStringsFileType();
        Matcher matcher = macStringsFileType.getTargetFilePattern().getPattern().matcher("/source/fr.lproj/Localizable.strings");
        Assert.assertTrue(matcher.matches());
        Assert.assertEquals("/source/", matcher.group(PARENT_PATH));
    ...
    public void testTargetPatternBcp47() {
        MacStringsFileType macStringsFileType = new MacStringsFileType();
        Matcher matcher = macStringsFileType.getTargetFilePattern().getPattern().matcher("/source/en-GB.lproj/Localizable.strings");
        Assert.assertTrue(matcher.matches());
        Assert.assertEquals("/source/", matcher.group(PARENT_PATH));
    ...
    public void testTargetPatternNoMatch() {
        MacStringsFileType macStringsFileType = new MacStringsFileType();
        Matcher matcher = macStringsFileType.getTargetFilePattern().getPattern().matcher("/source/en.lproj/Localizable.strings");
        Assert.assertFalse(matcher.matches());
    }
