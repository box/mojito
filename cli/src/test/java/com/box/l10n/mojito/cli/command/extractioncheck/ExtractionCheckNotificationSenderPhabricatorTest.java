...
public class ExtractionCheckNotificationSenderPhabricatorTest {
    ...
    @Captor
    ArgumentCaptor<String> objectIdCaptor;
    ...
    @Before
    public void setup() {
        extractionCheckNotificationSenderPhabricator = new ExtractionCheckNotificationSenderPhabricator("D12345", "{baseMessage}", "This is a hard failure message", "This is a checks skipped message");
    ...
    public void testSendChecksSkippedNotification() {
        ...
        verify(differentialRevisionMock, times(1)).addComment(objectIdCaptor.capture(), messageCaptor.capture());
        Assert.assertTrue(objectIdCaptor.getValue().equals("D12345"));
        Assert.assertTrue(messageCaptor.getValue().equals(PhabricatorIcon.WARNING+ " This is a checks skipped message"));
    }
