...
public class RecommendStringIdCheckerTest {
  ...
  public void setup() {
    ...
    assetExtractorTextUnit.setName(
        "A source string with no errors. --- someDir.someSubDir.someStringId");
  ...
  public void testFailure() {
    CliCheckResult result =
        recommendStringIdChecker.run(setTextUnitId("incorrect.prefix.someStringId"));
  ...
  public void testMultipleUsagesProvided() {
    ...
    AssetExtractorTextUnit assetExtractorTextUnit = new AssetExtractorTextUnit();
    assetExtractorTextUnit.setName(
        "A source string with no errors.  --- anotherDir.someSubDir.stringId");
    assetExtractorTextUnit.setSource("A source string with no errors.");
    assetExtractorTextUnit.setUsages(
        Sets.newHashSet(
            "someDir/someSubDir/anotherLevel/evenDeeper/someSourceFile.java:1497",
            "anotherDir/someSubDir/anotherLevel/evenDeeper/someSourceFile.java:1497"));
    addedTUs.add(assetExtractorTextUnit);
  ...
  public void testRecommendationWhenMultipleUsagesProvided() {
    ...
    AssetExtractorTextUnit assetExtractorTextUnit = new AssetExtractorTextUnit();
    assetExtractorTextUnit.setName(
        "A source string with no errors. --- aDifferentDir.someSubDir.stringId");
    assetExtractorTextUnit.setSource("A source string with no errors.");
    assetExtractorTextUnit.setUsages(
        Sets.newHashSet(
            "someDir/someSubDir/anotherLevel/evenDeeper/someSourceFile.java:1497",
    ...
    Assert.assertFalse(result.isSuccessful());
    Assert.assertTrue(
        result.getNotificationText().contains("someDir.someSubDir.")
            || result.getNotificationText().contains("anotherDir.someSubDir."));
  }
  ...
  public void testEmptyMsgContextReceivesRecommendation() {
    ...
    assetExtractorTextUnit.setSource("A source string with no errors.");
    assetExtractorTextUnit.setUsages(
        Sets.newHashSet("someDir/someSubDir/anotherLevel/evenDeeper/someSourceFile.java:1497"));
    addedTUs.add(assetExtractorTextUnit);
    List<AssetExtractionDiff> assetExtractionDiffs = new ArrayList<>();
    AssetExtractionDiff assetExtractionDiff = new AssetExtractionDiff();
    assetExtractionDiff.setAddedTextunits(addedTUs);
  ...
  public void testMultipleRecommendations() {
    ...
    assetExtractorTextUnit2.setUsages(
        Sets.newHashSet("someDir/someSubDir/someOtherSourceFile.java:2"));
  ...
  public void testLabelIsIgnored() {
    ...
    addedTUs.add(assetExtractorTextUnit);
    AssetExtractorTextUnit assetExtractorTextUnit2 = new AssetExtractorTextUnit();
    assetExtractorTextUnit2.setName(
        "Another source string with no errors. --- [aLabel] someOtherStringId [aLabel]");
    assetExtractorTextUnit2.setSource("Another source string with no errors.");
    assetExtractorTextUnit2.setUsages(
        Sets.newHashSet("someDir/someSubDir/someOtherSourceFile.java:2"));
    addedTUs.add(assetExtractorTextUnit2);
    ...
    recommendStringIdChecker.setCliCheckerOptions(
        new CliCheckerOptions(
            ...
            ImmutableMap.<String, String>builder()
                .put(RECOMMEND_STRING_ID_LABEL_IGNORE_PATTERN_KEY.getKey(), "\\[\\w+\\]")
                .build()));
  ...
  private List<AssetExtractionDiff> setTextUnitId(String id) {
    ...
    assetExtractorTextUnit.setSource("A source string with no errors.");
    assetExtractorTextUnit.setUsages(
        Sets.newHashSet("someDir/someSubDir/evenDeeperSubDir/someSourceFile.java:1111"));
    addedTUs.add(assetExtractorTextUnit);
    List<AssetExtractionDiff> assetExtractionDiffs = new ArrayList<>();
    AssetExtractionDiff assetExtractionDiff = new AssetExtractionDiff();
    assetExtractionDiff.setAddedTextunits(addedTUs);
