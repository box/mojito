...
public class RepoCreateCommandTest extends CLITestBase {
  ...
  protected void createTestRepoWith6Locales(
    ...
    // TODO need to ensure that if "en" (ie. the default locale) is in this request parameter, the
    // server won't add it in
  ...
  protected void assertCreatedRepositoryHas6Locales(
      String testRepoName, String testDescription, Boolean expectIntegrityChecker) {
    ...
    assertEquals(
        "fr-FR", repoLocaleMapByBcp47Tag.get("fr-CA").getParentLocale().getLocale().getBcp47Tag());
    assertEquals(
        "en-GB", repoLocaleMapByBcp47Tag.get("en-CA").getParentLocale().getLocale().getBcp47Tag());
    assertEquals(
        "en-GB", repoLocaleMapByBcp47Tag.get("en-AU").getParentLocale().getLocale().getBcp47Tag());
    ...
    if (expectIntegrityChecker) {
      ...
      for (AssetIntegrityChecker assetIntegrityChecker : repository.getAssetIntegrityCheckers()) {
        ...
        assertTrue(
            IntegrityCheckerType.MESSAGE_FORMAT == assetIntegrityChecker.getIntegrityCheckerType()
  ...
  public void testCreateTestRepoWithWebAppLocalesCorrectlyCreated() throws Exception {
    ...
    assertEquals(testDescription, repository.getDescription());
    assertEquals(
        "There are 22 repositoryLocale including the root locale",
        22,
        repository.getRepositoryLocales().size());
    ...
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("da-DK").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("de-DE").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("en-GB").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("es-ES").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("fi-FI").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("fr-FR").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("it-IT").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("ja-JP").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("ko-KR").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("nb-NO").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("nl-NL").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("pl-PL").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("pt-BR").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("ru-RU").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("sv-SE").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("tr-TR").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("zh-CN").getParentLocale());
    assertEquals(
        "en should be the root locale", en, repoLocaleMapByBcp47Tag.get("zh-TW").getParentLocale());

    assertEquals(
        "fr-FR should be the parent locale",
        "fr-FR",
        repoLocaleMapByBcp47Tag.get("fr-CA").getParentLocale().getLocale().getBcp47Tag());
    assertEquals(
        "en-GB should be the parent locale",
        "en-GB",
        repoLocaleMapByBcp47Tag.get("en-CA").getParentLocale().getLocale().getBcp47Tag());
    assertEquals(
        "en-GB should be the parent locale",
        "en-GB",
        repoLocaleMapByBcp47Tag.get("en-AU").getParentLocale().getLocale().getBcp47Tag());

    assertFalse(
        "This should be not fully translated",
        repoLocaleMapByBcp47Tag.get("fr-CA").isToBeFullyTranslated());
    assertFalse(
        "This should be not fully translated",
        repoLocaleMapByBcp47Tag.get("en-CA").isToBeFullyTranslated());
    assertFalse(
        "This should be not fully translated",
        repoLocaleMapByBcp47Tag.get("en-AU").isToBeFullyTranslated());

    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("da-DK").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("de-DE").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("en-GB").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("es-ES").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("fi-FI").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("fr-FR").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("it-IT").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("ja-JP").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("ko-KR").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("nb-NO").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("nl-NL").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("pl-PL").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("pt-BR").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("ru-RU").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("sv-SE").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("tr-TR").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("zh-CN").isToBeFullyTranslated());
    assertTrue(
        "This should be fully translated",
        repoLocaleMapByBcp47Tag.get("zh-TW").isToBeFullyTranslated());
  ...
  public void testConflict() throws Exception {
    ...
    assertTrue(
        "Error because the repository has already been created",
        outputCapture
            .toString()
            .contains("Repository with name [" + testRepoName + "] already exists"));
  }

  @Test
  @Ignore(
      "we don't support multilevel hierarechy yet with cycle check.  Running test will result in: java.lang.IllegalArgumentException: Parent locale: en-CA doesn't exist in repository")
  public void testCreateTestRepoWithMultiLevelHiererchyAcrossTwoChains() throws Exception {
    ...
    assertEquals(testDescription, repository.getDescription());
    assertEquals(
        "Total number of locales including the root locale",
        6,
        repository.getRepositoryLocales().size());
    ...
    assertEquals(
        "en is the root locale", en, repoLocaleMapByBcp47Tag.get("fr-FR").getParentLocale());
    assertEquals(
        "fr-FR", repoLocaleMapByBcp47Tag.get("fr-CA").getParentLocale().getLocale().getBcp47Tag());
    assertEquals(
        "en-GB", repoLocaleMapByBcp47Tag.get("en-CA").getParentLocale().getLocale().getBcp47Tag());
    assertEquals(
        "en-CA", repoLocaleMapByBcp47Tag.get("en-AU").getParentLocale().getLocale().getBcp47Tag());
    assertEquals(
        "en is the root locale", en, repoLocaleMapByBcp47Tag.get("en-GB").getParentLocale());
  ...
  public void testUnsupportedMultipleLevelChain() throws Exception {
    ...
    assertTrue(
        "Multi level chain with en-AU->en-CA->en-GB is not supported",
        outputCapture.toString().contains(COMMAND_ERROR_MESSAGE));
  }
  ...
  public void testForConflict1() throws Exception {
    ...
    getL10nJCommander()
        .run(
            ...
            Param.REPOSITORY_DESCRIPTION_SHORT,
            testIdWatcher.getEntityName("repository") + " description",
            Param.REPOSITORY_LOCALES_SHORT,
            "en-GB",
            "en-CA->en-GB",
            "en-GB->en-CA");
    ...
    assertTrue(
        "There should be a conflict for the set of locales",
        outputCapture.toString().contains(COMMAND_ERROR_MESSAGE));
  }
  ...
  public void testForConflictForRootLocale() throws Exception {
    ...
    assertTrue(
        ...
        outputCapture
            .toString()
            .contains("Locale [en] cannot be added because it is the root locale"));
  }
  ...
  public void testForCycle2() throws Exception {
    ...
    assertTrue(
        "There should be a conflict between \"en-CA->en-GB\", \"en-GB->en-CA\"",
        outputCapture.toString().contains("Found a cycle"));
  }
  ...
  public void testDifferentSourceLocale() {
    ...
    getL10nJCommander()
        .run(
            ...
            Param.REPOSITORY_DESCRIPTION_SHORT,
            testDescription,
            Param.REPOSITORY_SOURCE_LOCALE_SHORT,
            "fr-FR",
            Param.REPOSITORY_LOCALES_SHORT,
            "en",
            "it-IT");
