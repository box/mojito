...
public class XtbFileTypeTest {
    ...
    public void testTargetPattern() {
        XtbFileType xtbFileType = new XtbFileType();
        Matcher matcher = xtbFileType.getTargetFilePattern().getPattern().matcher("/source/Filefinder-fr.xtb");
        Assert.assertTrue(matcher.matches());
    ...
    public void testTargetPatternBcp47() {
        XtbFileType xtbFileType = new XtbFileType();
        Matcher matcher = xtbFileType.getTargetFilePattern().getPattern().matcher("/source/Filefinder-en-GB.xtb");
        Assert.assertTrue(matcher.matches());
