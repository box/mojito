...
public class RepoUpdateCommandTest extends CLITestBase {
    ...
    public void testUpdateName() throws Exception {
        ...
        getL10nJCommander().run(
                ...
                Param.REPOSITORY_NEW_NAME_SHORT, newName
        );
    ...
    public void testUpdateLocalesWithInheritance() throws Exception {
        ...
        getL10nJCommander().run(
                ...
                Param.REPOSITORY_NAME_SHORT, testRepoName,
                Param.REPOSITORY_NEW_NAME_SHORT, newName,
                Param.REPOSITORY_LOCALES_SHORT, "en-GB", "en-CA->en-GB", "(en-AU)->en-GB", "fr-FR", "ko-KR"
        );
        ...
        for (RepositoryLocale repositoryLocale : repository.getRepositoryLocales()) {
            ...
            if (repositoryLocale.getParentLocale() != null) {
                if ("en-CA".equals(repositoryLocale.getLocale().getBcp47Tag()) || "en-AU".equals(repositoryLocale.getLocale().getBcp47Tag())) {
    ...
    public void testUpdateAll() throws Exception {
        ...
        getL10nJCommander().run(
                ...
                Param.REPOSITORY_NAME_SHORT, testRepoName,
                Param.REPOSITORY_NEW_NAME_SHORT, newName,
                Param.REPOSITORY_DESCRIPTION_SHORT, newDescription,
                Param.REPOSITORY_LOCALES_SHORT, "de-DE",
    ...
    public void testUpdateIntegrityChecker() throws Exception {
        ...
        getL10nJCommander().run(
                "repo-update",
                Param.REPOSITORY_NAME_SHORT, testRepoName,
                RepoCommand.INTEGRITY_CHECK_SHORT_PARAM, "resx:COMPOSITE_FORMAT"
        );
        assertTrue("Repository is not updated successfully", outputCapture.toString().contains("updated --> repository name: "));
