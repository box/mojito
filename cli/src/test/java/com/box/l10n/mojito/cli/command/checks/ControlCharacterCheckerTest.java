...
public class ControlCharacterCheckerTest {
  ...
  public void setup() {
    ...
    controlCharacterChecker.setCliCheckerOptions(
        new CliCheckerOptions(
            Sets.newHashSet(), Sets.newHashSet(), ImmutableMap.<String, String>builder().build()));
  ...
  public void testMultipleControlCharactersInString() {
    ...
    assertTrue(
        result
            .getNotificationText()
            .contains("\u0010Text containing multiple \u0000 control characters.\u0007"));
