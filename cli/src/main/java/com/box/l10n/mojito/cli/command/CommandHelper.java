...
public class CommandHelper {
    ...
    /**
     * Returns the exported xliff generated by the {@link PollableTask}.
     *
     * @param pollableId
     * @return
     */
    public String getPollableTaskXliff(Long pollableId) {
        XliffExportBody xliffExportBody = pollableTaskClient.getPollableTaskXliffExport(pollableId);
        return xliffExportBody.getContent();
    }
