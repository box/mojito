...
public class Param {
    ...
    public static final String COMMIT_CREATE_DESCRIPTION = "The commit hash that will be used when recording a commit.";
    ...
    public static final String CREATION_DATE_DESCRIPTION = "The date when the commit was merged into the mainline branch.";
}
