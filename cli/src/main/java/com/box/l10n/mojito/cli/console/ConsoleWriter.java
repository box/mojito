...
/**
 * Builds and prints messages with ANSI escape codes to standard output and logger.
 *
 * <p>Printing of ANSI escape codes can be disabled for standard output (Logger messages never
 * contain escape codes).
 *
 * @author jaurambault
 */
public class ConsoleWriter {
  ...
  /**
   * Appends a new line at the end of the message then prints the message to the standard output and
   * to logger.
   *
   * @return this instance
   */
  ...
  /**
   * Appends new lines at the end of the message then prints the message to the standard output and
   * to logger.
   *
   * @param numberOfNewLines number of new lines to append at then end of the message.
   * @return this instance
   */
