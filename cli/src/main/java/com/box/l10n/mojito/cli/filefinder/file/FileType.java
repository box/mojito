...
/**
 * Provides information about a file type: extension, directory layout, source and target file
 * pattern, etc.
 *
 * @author jaurambault
 */
public abstract class FileType {
  ...
  Pattern textUnitNameToTextUnitNameInSourcePlural =
   ...
   *
   * <p>This is used with format (like PO files) that have different source and target file
   * extension (eg. pot and po)
   *
   * @return the target file extension if defined else the source file extension
   */
  ...
  public void setTextUnitNameToTextUnitNameInSourcePlural(
      Pattern textUnitNameToTextUnitNameInSourcePlural) {
  ...
  public void setTextUnitNameToTextUnitNameInSourceSingular(
      Pattern textUnitNameToTextUnitNameInSourceSingular) {
