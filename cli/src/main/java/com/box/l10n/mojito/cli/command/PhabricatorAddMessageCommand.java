...
@Component
@Scope("prototype")
@Parameters(commandNames = {"phab-add-msg"}, commandDescription = "Add a message to a Phabricator revision")
public class PhabricatorAddMessageCommand extends Command {
    ...
    @Parameter(names = {"--object-id", "-o"}, arity = 1, required = true, description = "the object id of the revision")
    String objectId;
