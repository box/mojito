...
public class PrintfLikeVariableTypePlaceholderDescriptionChecker extends AbstractPlaceholderDescriptionCheck {
    ...
    private static final PlaceholderRegularExpressions REGEX = PlaceholderRegularExpressions.PRINTF_LIKE_VARIABLE_TYPE_REGEX;

    private Pattern pattern = Pattern.compile(REGEX.getRegex());
