...
public abstract class RepoCommand extends Command {
    ...
    protected static final String INTEGRITY_CHECK_DESCRIPTION
            ...
            + "Available Checker types: MESSAGE_FORMAT, MESSAGE_FORMAT_DOUBLE_BRACES, PRINTF_LIKE, PRINTF_LIKE_IGNORE_PERCENTAGE_AFTER_BRACKETS, PRINTF_LIKE_VARIABLE_TYPE, SIMPLE_PRINTF_LIKE, COMPOSITE_FORMAT, WHITESPACE, TRAILING_WHITESPACE, HTML_TAG, ELLIPSIS, BACKQUOTE\n       "
